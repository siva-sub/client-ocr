...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},ps=(e,t)=>new ds(e,t)}),cs,zi,fs,hs,ms,gs,Be,_s,ys,st=P(()=>{J(),re(),we(),ne(),cs=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},zi=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),fs=(e,t)=>C.sortBasedOnPerm(e,zi(e.length,t)),hs=(e,t,r,i)=>{let a=`fn perm(i: ${i.type.indices}) -> ${r.type.indices} {
  ...
  }`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let _=C.size(n);return{outputs:[{dims:n,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(_/64/4)},programUniforms:[{type:12,data:Math.ceil(_/4)}]}},getShaderSource:d};let{newShape:c,newPerm:f}=ms(e.dims,a),m=C.areEqual(f,[2,3,1]),g=C.areEqual(f,[3,1,2]);if(c.length===2||m||g){s=m?[c[0],c[1]*c[2]]:g?[c[0]*c[1],c[2]]:c,u=[s[1],s[0]];let _=16;return d=b=>{let k=B("a",r,s.length),v=G("output",r,u.length);return`
  ...
  ${_.mainStart()}
    ...
    ${k.setByOffset("global_idx",b.getByIndices("aIndices"))}
       ...
       `,_=b=>`
        ...
        }`;return{name:e,shaderCache:{hint:`${t};${m}`,inputDependencies:["type"]},getShaderSource:_,getRunData:()=>({outputs:[{dims:n,dataType:a}],dispatchGroup:{x:l},programUniforms:[{type:12,data:d}]})}},Le=(e,t,r,i)=>{let a=e.inputs.length===1?r:Ci(e.inputs,r),n=a.axes;n.length===0&&!a.noopWithEmptyAxes&&(n=e.inputs[0].dims.map((g,_)=>_));let s=C.normalizeAxes(n,e.inputs[0].dims.length),u=s,l=e.inputs[0],d=Is(u,e.inputs[0].dims.length);d.length>0&&(l=e.compute(Be(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],u=xs(u.length,l.dims.length));let[c,f]=ks(l.dims,u),m=c;a.keepDims&&(m=Ss(c,s)),e.compute(Es(t,a.cacheKey,[l],i,e.inputs[0].dataType,m,f),{inputs:[l]})},zs=(e,t)=>{Le(e,"ReduceMeanShared",t,"mean")},Cs=(e,t)=>{Le(e,"ReduceL1Shared",t,"l1")},Os=(e,t)=>{Le(e,"ReduceL2Shared",t,"l2")},As=(e,t)=>{Le(e,"ReduceLogSumExpShared",t,"logSumExp")},Bs=(e,t)=>{Le(e,"ReduceMaxShared",t,"max")},Rs=(e,t)=>{Le(e,"ReduceMinShared",t,"min")},Ms=(e,t)=>{Le(e,"ReduceProdShared",t,"prod")},Ns=(e,t)=>{Le(e,"ReduceSumShared",t,"sum")},Ds=(e,t)=>{Le(e,"ReduceSumSquareShared",t,"sumSquare")},Ps=(e,t)=>{Le(e,"ReduceLogSumShared",t,"logSum")}}),Ve,Us,yr,Ci,Ge,qs,Ws,Ls,Vs,Gs,Hs,Fs,js,Ks,Zs,He,Qs,Xs,Ys,Js,eo,to,ro,io,ao,no,Oi=P(()=>{J(),re(),we(),ne(),ih(),Ve=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Us=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],yr=(e,t,r,i,a,n,s=!1,u=!1)=>{let l=[],d=r[0].dims,c=d.length,f=C.normalizeAxes(a,c),m=!u&&f.length===0;d.forEach((b,k)=>{m||f.indexOf(k)>=0?s&&l.push(1):l.push(b)});let g=l.length,_=C.size(l);return{name:e,shaderCache:t,getShaderSource:b=>{let k=[],v=B("_A",r[0].dataType,c),w=G("output",n,g),S=i(v,w,f),x=S[2];for(let T=0,z=0;T<c;T++)m||f.indexOf(T)>=0?(s&&z++,x=`for(var j${T}: u32 = 0; j${T} < ${d[T]}; j${T}++) {
...
`},Wi=(e,t,r,i,a=!1,n)=>{let s=e[0].dims,u=e[1].dims,l=s[s.length-2],d=u[u.length-1],c=s[s.length-1],f=be(d),m=be(c),g=be(l),_=C.size(r)/f/g,b=e.length>2,k=i?i.slice(0,-2):r.slice(0,-2),v=[C.size(k),l,d],w=[{type:12,data:_},{type:12,data:l},{type:12,data:d},{type:12,data:c}];wt(t,w),w.push(...Z(k,s,u)),b&&w.push(...Z(e[2].dims)),w.push(...Z(v));let S=x=>{let T=Ei("batch_dims",e[0].dataType,k.length),z=B("a",e[0].dataType,s.length,m),E=B("b",e[1].dataType,u.length,f),A=G("output",e[0].dataType,v.length,f),N=ke(A.type.tensor),L=bt(t,A.type.value,N),Y=[z,E],F="";if(b){let ie=a?f:1;Y.push(B("bias",e[2].dataType,e[2].dims.length,ie)),F=`${a?`value += bias[col / ${ie}];`:`value += ${A.type.value}(bias[row + i]);`}`}let ee=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];$t(t,ee);let U=()=>{let ie=`var a_data: ${z.type.value};`;for(let Q=0;Q<m;Q++)ie+=`
              let b_data${Q} = b[(b_offset + (k + ${Q}) * uniforms.N + col) / ${f}];`;for(let Q=0;Q<g;Q++){ie+=`a_data = a[(a_offset + (row + ${Q}) * uniforms.K + k) / ${m}];`;for(let V=0;V<m;V++)ie+=`
...
`}return ie};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${f};${m};${g};${a}`,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:n?n(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:w}),getShaderSource:S}}}),Cu,Ou,Vi,Gi,Au,Hi,Bu,$r,Fi=P(()=>{J(),re(),ne(),vt(),Li(),qi(),Cu=(e,t)=>e?`
...
`},Bu=(e,t,r,i,a=!1)=>{let[n,s,u,l]=i,d=ke(i[0].type.tensor);return`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${f}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:g}),getShaderSource:b}},Lu=(e,t,r,i)=>{let a=e.length>2,n=be(r[3]),s=be(r[2]),u=C.size(r)/n/s,l=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/n],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/n],c=[r[0],r[1],r[2],r[3]/n],f=[{type:12,data:u},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];wt(t,f),f.push(...Z(l,d,c));let m=(s-1)*t.strides[1]+d[1],g=_=>{let b=G("output",e[0].dataType,c.length,n),k=ke(b.type.tensor),v=bt(t,b.type.value,k),w=B("x",e[0].dataType,l.length,n),S=B("w",e[1].dataType,d.length,n),x=[w,S];a&&x.push(B("b",e[2].dataType,e[2].dims,n));let T=a?"value += b[output_channel];":"",z=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return $t(t,z),`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${n};${s};${m};${d[0]};${d[1]}`,inputDependencies:a?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:f}),getShaderSource:g}}}),Vu,vr,Gu,xr,Zi,Qi,Hu,Fu,Xi,hh=P(()=>{re(),ph(),ch(),Fi(),fh(),vt(),Li(),st(),Vu=(e,t,r,i,a,n)=>{let s=e[0],u=e.slice(n?1:2,n?3:4),l=u.length,d=t[0],c=t.slice(2).map((m,g)=>m+(m-1)*(r[g]-1)),f=u.map((m,g)=>m+i[g]+i[g+l]).map((m,g)=>Math.floor((m-c[g]+a[g])/a[g]));return f.splice(0,0,s),f.splice(n?3:1,0,d),f},vr=[2,3,1,0],Gu=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],i=e[1].dims[1]*t.group;if(r!==i)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let a=e[0].dims.length-2;if(t.dilations.length!==a)throw new Error(`dilations should be ${a}D`);if(t.strides.length!==a)throw new Error(`strides should be ${a}D`);if(t.pads.length!==a*2)throw new Error(`pads should be ${a*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},xr=(e,t)=>{let r=e.kernelShape.slice();r.length<t[1].dims.length-2&&r.push(...Array(t[1].dims.length-2-r.length).fill(0));for(let n=2;n<t[1].dims.length;++n)r[n-2]===0&&(r[n-2]=t[1].dims[n]);let i=e.pads.slice();hr.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,i,e.format==="NHWC",e.autoPad);let a=Object.assign({},e);return Object.assign(a,{kernelShape:r,pads:i}),a},Zi=e=>{let t=Ui(e),r=e.format,i=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],a=e.dilations,n=e.group,s=e.kernel_shape,u=e.pads,l=e.strides,d=e.w_is_const();return{autoPad:i,format:r,dilations:a,group:n,kernelShape:s,pads:u,strides:l,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},Qi=(e,t,r,i)=>{let a=r.format==="NHWC",n=Vu(t[0].dims,t[1].dims,r.dilations,r.pads,r.strides,a);if(r.group!==1){let z=[t[0]];if(a){let E=e.kernelCustomData.wT??e.compute(Be(t[1],vr),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=E),z.push(E)}else z.push(t[1]);t.length===3&&z.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&a&&t[1].dims[0]===r.group&&t[1].dims[1]===1&&r.dilations[0]===1&&r.dilations[1]===1?e.compute(Lu(z,r,n,i),{inputs:z}):e.compute(Wu(z,r,n,i),{inputs:z});return}let s=t.length===3,u=t[0].dims[a?1:2],l=t[0].dims[a?2:3],d=t[0].dims[a?3:1],c=t[1].dims[2],f=t[1].dims[3],m=n[a?1:2],g=n[a?2:3],_=n[a?3:1],b=a&&c===u&&f===l&&r.pads[0]===0&&r.pads[1]===0;if(b||c===1&&f===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let z=n[0],E,A,N,L=[];if(a){let ee=e.kernelCustomData.wT??e.compute(Be(t[1],vr),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=ee),b){let U=u*l*d;E=t[0].reshape([1,z,U]),A=ee.reshape([1,U,_]),N=[1,z,_]}else E=t[0].reshape([z,u*l,d]),A=ee.reshape([1,d,_]),N=[z,m*g,_];L.push(E),L.push(A)}else E=t[0].reshape([z,d,u*l]),A=t[1].reshape([1,_,d]),N=[z,_,m*g],L.push(A),L.push(E);s&&L.push(t[2]);let Y=N[2],F=L[0].dims[L[0].dims.length-1];Y<8&&F<8?e.compute(Wi(L,r,n,N,a,i),{inputs:L}):e.compute($r(L,r,n,N,a,i),{inputs:L});return}let k=!0,v=e.kernelCustomData.wT??e.compute(Be(t[1],vr),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=v);let w=[t[0],v];s&&w.push(t[2]);let S=a?m*g:_,x=a?_:m*g,T=c*f*d;e.compute(Mu(w,r,n,S,x,T,s,k,i),{inputs:w})},Hu=(e,t)=>{let r=t.format==="NHWC",i=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&i.push(e.inputs[2]);let a=[0,t.pads[0],0,t.pads[1]],n=[1].concat(t.strides),s=[1].concat(t.dilations),u=[1].concat(t.kernelShape),l=xr({...t,pads:a,strides:n,dilations:s,kernelShape:u},i);Qi(e,i,l,d=>r?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},Fu=(e,t,r)=>{let i=r.format==="NHWC"?"channelsLast":"channelsFirst",a=xr(r,t),n=r.autoPad==="NOTSET"?r.pads:r.autoPad,s=Uu(t[0].dims,t[1].dims,r.strides,r.dilations,n,!1,i);e.compute(qu(t,a,s.outShape,[s.filterDepth,s.filterHeight,s.filterWidth],[s.padInfo.front,s.padInfo.top,s.padInfo.left],i))},Xi=(e,t)=>{if(Gu(e.inputs,t),e.inputs[0].dims.length===3)Hu(e,t);else if(e.inputs[0].dims.length===5)Fu(e,e.inputs,t);else{let r=xr(t,e.inputs);Qi(e,e.inputs,r)}}}),ju,mh=P(()=>{J(),et(),re(),ne(),ju=(e,t,r)=>{let i=e.length>2,a=t.outputShape,n=t.format==="NHWC",s=t.group,u=e[1].dims,l=u[2]/s,d=u[3],c=n?be(l):1,f=n&&d===1&&l>=4,m=f?Math.floor(l/4)*4:Math.floor(l/c)*c,g=l-m,_=n?be(d):1,b=n?d===1?c:_:1,k=C.size(a)/_,v=[Math.ceil(k/64),1,1];le("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${v}`);let w=["rank","rank"],S=[t.strides[0],t.strides[1]],x=[t.kernelShape[n?1:2],t.kernelShape[n?2:3]],T=[t.dilations[0],t.dilations[1]],z=[x[0]+(t.dilations[0]<=1?0:(t.kernelShape[n?1:2]-1)*(t.dilations[0]-1)),x[1]+(t.dilations[1]<=1?0:(t.kernelShape[n?2:3]-1)*(t.dilations[1]-1))],E=[z[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),z[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],A=[{type:12,data:k},{type:12,data:S},{type:12,data:x},{type:12,data:T},{type:12,data:z},{type:6,data:E},{type:12,data:m},{type:12,data:l},{type:12,data:d},...Z(e[0].dims,e[1].dims)];i&&(A.push(...Z(e[2].dims)),w.push("rank")),A.push(...Z(a));let N=L=>{let Y=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:S.length},{name:"filter_dims",type:"u32",length:x.length},{name:"dilations",type:"u32",length:x.length},{name:"effective_filter_dims",type:"u32",length:z.length},{name:"pads",type:"i32",length:E.length},{name:"input_channels_per_group_int",type:"u32"},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],F=ke(e[0].dataType),ee=n?1:2,U=n?2:3,ie=n?3:1,Q=B("W",e[1].dataType,e[1].dims.length,b),V=B("Dy",e[0].dataType,e[0].dims.length,c),oe=[V,Q];i&&oe.push(B("bias",e[2].dataType,[a[ie]].length,_));let j=G("result",e[0].dataType,a.length,_),ue=()=>{let te="";if(f)c===4?te+=`
...
`)};
    ...
    ${_}`},c=[{type:12,data:l},...Z(t,i)];return{name:"Expand",shaderCache:{hint:`${i.length};${s}${u}`,inputDependencies:["rank"]},getShaderSource:d,getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:c})}},bl=e=>{gl(e.inputs),e.compute(yl(e.inputs),{inputs:[0]})}}),wl,$l,$h=P(()=>{J(),re(),ne(),Pi(),wl=e=>{let t=e[0].dataType,r=C.size(e[0].dims),i=C.size(e[1].dims),a=i%4===0,n=s=>{let u=B("x",t,[1],4),l=B("bias",t,[1],4),d=G("y",t,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],f=g=>`
  ...
  ${m.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((g,_)=>_!==1).map(g=>g.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(g,_)=>"rank")},getRunData:()=>({outputs:[{dims:u,dataType:d}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:f}),getShaderSource:m}},Ol=(e,t)=>{let r=e.inputs;zl(r,t),e.compute(Cl(e.inputs,t))},Al=e=>ce({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),Bl,Rl,Ml,Nl,Sh=P(()=>{J(),re(),we(),ne(),Bl=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
...
`,jl=(e,t,r)=>(()=>{switch(r.mode){case"nearest":return`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:c},{inputs:[t,r],outputs:[-1]})[0]},Zt=(e,t,r,i,a,n,s,u)=>{let l=n;if(s&&C.size(s.dims)>0){if(i===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return l=Jl(e,n,s,t,i,r*a,u),l=l.reshape([t,i,r,a]),r===1||i===1?l:e.compute(Be(l,ia.perm),{inputs:[l],outputs:[-1]})[0]}else return n.dims.length===3&&(l=n.reshape([t,i,r,a])),r===1||i===1?l:e.compute(Be(l,ia.perm),{inputs:[l],outputs:[-1]})[0]},ed=(e,t)=>{let r=Xl(e.inputs,t),i=e.inputs[0],a=Ee(e.inputs,1),n=Ee(e.inputs,2),s=Ee(e.inputs,3),u=Ee(e.inputs,4),l=Ee(e.inputs,5),d=Ee(e.inputs,6),c=Ee(e.inputs,7);if(i.dims.length===5)throw new Error("Packed QKV is not implemented");if(a?.dims.length===5)throw new Error("Packed KV is not implemented");let f=a&&n&&a.dims.length===4&&n.dims.length===4,m=Zt(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,i,s,0);if(f)return Gt(e,m,a,n,u,void 0,d,c,l,r);if(!a||!n)throw new Error("key and value must be provided");let g=Zt(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,a,s,r.hiddenSize),_=Zt(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,n,s,2*r.hiddenSize);Gt(e,m,g,_,u,void 0,d,c,l,r)}}),rd,id,ad,nd,aa,sd,od,ud=P(()=>{J(),re(),we(),ne(),rd=e=>{if(!e||e.length<1)throw new Error("too few inputs")},id=(e,t)=>{let r=[],i=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(a=>r.push(Number(a))),i=r.length),ce({numOutputs:i,axis:t.axis,splitSizes:r})},ad=e=>`
...
`)}
  ...
  ${T.mainStart()}
    ...
    data_offset += u32((u32(index) * element_count_dim));`,ga=(e,t,r)=>`for (var i = 0u; i < uniforms.num_updates_elements; i++) {
      ...
      }`,rp=(e,t)=>{let r=e[0].dims,i=e[1].dims,a=r,n=1,s=Math.ceil(C.size(i)/n),u=i[i.length-1],l=C.sizeFromDimension(r,u),d=C.sizeFromDimension(i,0)/u,c=[{type:12,data:s},{type:12,data:u},{type:12,data:l},...Z(e[1].dims,e[2].dims,a)],f=m=>{let g=B("indices",e[1].dataType,e[1].dims.length),_=B("updates",e[2].dataType,e[2].dims.length,n),b=t.reduction!=="none"&&t.reduction!==""?ls("output",e[0].dataType,a.length):G("output",e[0].dataType,a.length,n);return`
...
`:"",gp=(e,t,r,i,a)=>{let[n,s,u,l]=r.length===2?[-1,0,1,-1]:[0,2,3,1],d=e.type.value;return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${g} {
    ...
    }`},bp=(e,t,r,i,a,n)=>{let s=e.dims,u=dp(n,t.axes,s.length),l=pp(s,i,a,t.axes),d=i.slice();i.length===0&&(d=s.map((w,S)=>w===0?1:l[S]/w),t.keepAspectRatioPolicy!=="stretch"&&(l=cp(s,d,t)));let c=G("output",e.dataType,l.length),f=B("input",e.dataType,s.length),m=C.size(l),g=s.length===l.length&&s.every((w,S)=>w===l[S]),_=t.coordinateTransformMode==="tf_crop_and_resize",b=t.extrapolationValue,k=f.type.value,v=w=>`
      ${g?"":`
...
`).filter(n=>n.length>0),r.dictionary||(r.dictionary=r.character)))}catch(i){console.warn("Failed to extract metadata from model:",i)}return r}static hasEmbeddedDictionary(t){return!!(t.metadata.dictionary&&t.metadata.dictionary.length>0)}static async getDictionary(t,r){if(this.hasEmbeddedDictionary(t))return console.log("Using embedded dictionary from model metadata"),t.metadata.dictionary;if(r){console.log("Loading external dictionary from:",r);try{const a=await(await fetch(r)).text();return Xh(r)?Yh(a):a.split(`
`).filter(n=>n.length>0)}catch(i){throw console.error("Failed to load external dictionary:",i),i}}throw new Error("No dictionary available: model has no embedded dictionary and no fallback path provided")}}let It=null,je=null;self.addEventListener("message",async e=>{const{type:t,data:r}=e.data;switch(t){case"INIT":try{console.log("Initializing classification model:",r.modelPath),It=await Jh.loadModel(r.modelPath),console.log("Classification model initialized successfully"),console.log("Input names:",It.session.inputNames),console.log("Output names:",It.session.outputNames),je=r.config?.cls||{engine_type:"onnxruntime",lang_type:"en",model_type:"mobile",ocr_version:"PP-OCRv4",cls_image_shape:[3,48,192],cls_batch_num:6,cls_thresh:.9,label_list:["0","180"]},self.postMessage({type:"RESULT",data:{initialized:!0}})}catch(i){self.postMessage({type:"ERROR",error:i.message})}break;case"CLASSIFY":if(!It||!je){self.postMessage({type:"ERROR",error:"Model not initialized"});return}try{const{images:i}=r,a=[],n=je.cls_batch_num||6;for(let s=0;s<i.length;s+=n){const u=i.slice(s,s+n),l=await em(u);a.push(...l),self.postMessage({type:"PROGRESS",progress:Math.min((s+n)/i.length,1)})}self.postMessage({type:"RESULT",data:{results:a}})}catch(i){self.postMessage({type:"ERROR",error:i.message})}break}});async function em(e){if(!It||!je)throw new Error("Model not initialized");const t=[];for(const _ of e){const b=tm(_.data,_.width,_.height);t.push(b)}const r=new Float32Array(t.length*t[0].data.length);t.forEach((_,b)=>{r.set(_.data,b*_.data.length)});const[i,a,n,s]=[t.length,...je.cls_image_shape],u=new Me("float32",r,[i,a,n,s]),d={[It.session.inputNames[0]||"input"]:u},c=await It.session.run(d),f=[],g=c[Object.keys(c)[0]].data;for(let _=0;_<i;_++){const b=rm(g,_);f.push(b)}return f}function tm(e,t,r){if(!je)throw new Error("Config not initialized");const[i,a,n]=je.cls_image_shape,u=new OffscreenCanvas(n,a).getContext("2d"),l=new ImageData(new Uint8ClampedArray(e),t,r),d=new OffscreenCanvas(t,r);d.getContext("2d").putImageData(l,0,0),u.drawImage(d,0,0,t,r,0,0,n,a);const f=u.getImageData(0,0,n,a).data,m=new Float32Array(i*a*n);for(let g=0;g<a;g++)for(let _=0;_<n;_++){const b=(g*n+_)*4,k=g*n+_,v=f[b]/255,w=f[b+1]/255,S=f[b+2]/255;m[k]=(v-.5)/.5,m[a*n+k]=(w-.5)/.5,m[2*a*n+k]=(S-.5)/.5}return new Me("float32",m,[1,i,a,n])}function rm(e,t){if(!je)throw new Error("Config not initialized");const r=je.label_list.length,i=t*r,a=e.slice(i,i+r),n=Math.max(...a),s=a.map(g=>Math.exp(g-n)),u=s.reduce((g,_)=>g+_,0),l=s.map(g=>g/u);let d=0,c=l[0];for(let g=1;g<l.length;g++)l[g]>c&&(c=l[g],d=g);const f=je.label_list[d]==="180"?180:0,m=f===180&&c>=je.cls_thresh;return{angle:f,confidence:c,shouldRotate:m}}})();
