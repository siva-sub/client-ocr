  ...
  ${_.mainStart()}
    ...
    ${k.setByOffset("global_idx",b.getByIndices("aIndices"))}
       ...
       `,_=b=>`
        ...
        }`;return{name:e,shaderCache:{hint:`${t};${h}`,inputDependencies:["type"]},getShaderSource:_,getRunData:()=>({outputs:[{dims:n,dataType:a}],dispatchGroup:{x:l},programUniforms:[{type:12,data:d}]})}},Le=(e,t,r,i)=>{let a=e.inputs.length===1?r:zi(e.inputs,r),n=a.axes;n.length===0&&!a.noopWithEmptyAxes&&(n=e.inputs[0].dims.map((g,_)=>_));let s=C.normalizeAxes(n,e.inputs[0].dims.length),u=s,l=e.inputs[0],d=Ts(u,e.inputs[0].dims.length);d.length>0&&(l=e.compute(Be(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],u=vs(u.length,l.dims.length));let[c,f]=xs(l.dims,u),h=c;a.keepDims&&(h=ks(c,s)),e.compute(Is(t,a.cacheKey,[l],i,e.inputs[0].dataType,h,f),{inputs:[l]})},Es=(e,t)=>{Le(e,"ReduceMeanShared",t,"mean")},zs=(e,t)=>{Le(e,"ReduceL1Shared",t,"l1")},Cs=(e,t)=>{Le(e,"ReduceL2Shared",t,"l2")},Os=(e,t)=>{Le(e,"ReduceLogSumExpShared",t,"logSumExp")},As=(e,t)=>{Le(e,"ReduceMaxShared",t,"max")},Bs=(e,t)=>{Le(e,"ReduceMinShared",t,"min")},Rs=(e,t)=>{Le(e,"ReduceProdShared",t,"prod")},Ms=(e,t)=>{Le(e,"ReduceSumShared",t,"sum")},Ns=(e,t)=>{Le(e,"ReduceSumSquareShared",t,"sumSquare")},Ds=(e,t)=>{Le(e,"ReduceLogSumShared",t,"logSum")}}),Ve,Ps,_r,zi,Ge,Us,qs,Ws,Ls,Vs,Gs,Hs,Fs,js,Ks,He,Zs,Qs,Xs,Ys,Js,eo,to,ro,io,ao,Ci=P(()=>{J(),re(),we(),ne(),nh(),Ve=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Ps=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],_r=(e,t,r,i,a,n,s=!1,u=!1)=>{let l=[],d=r[0].dims,c=d.length,f=C.normalizeAxes(a,c),h=!u&&f.length===0;d.forEach((b,k)=>{h||f.indexOf(k)>=0?s&&l.push(1):l.push(b)});let g=l.length,_=C.size(l);return{name:e,shaderCache:t,getShaderSource:b=>{let k=[],$=B("_A",r[0].dataType,c),w=G("output",n,g),S=i($,w,f),x=S[2];for(let T=0,z=0;T<c;T++)h||f.indexOf(T)>=0?(s&&z++,x=`for(var j${T}: u32 = 0; j${T} < ${d[T]}; j${T}++) {
...
`)}
        }`},getRunData:()=>({outputs:[{dims:l,dataType:n}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:[{type:12,data:_},...Z(d,l)]})}},zi=(e,t)=>{let r=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(i=>r.push(Number(i))),ce({axes:r,keepDims:t.keepDims,noopWithEmptyAxes:t.noopWithEmptyAxes})},Ge=(e,t,r,i)=>{let a=e.inputs,n=a.length===1?r:zi(a,r);e.compute(_r(t,{hint:n.cacheKey,inputDependencies:["rank"]},[a[0]],n.noopWithEmptyAxes&&n.axes.length===0?Ps:i,n.axes,a[0].dataType,n.keepDims,n.noopWithEmptyAxes),{inputs:[0]})},Us=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceLogSum",t,(r,i)=>[`var value = ${i.type.storage}(0);`,"",`value += ${r.getByIndices("input_indices")};`,"value = log(value);"])},qs=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceL1",t,(r,i)=>[`var value = ${i.type.storage}(0);`,"",`value += abs(${r.getByIndices("input_indices")});`,""])},Ws=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceL2",t,(r,i)=>[`var t = ${i.type.value}(0); var value = ${i.type.value}(0);`,"",`t = ${r.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])},Ls=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceLogSumExp",t,(r,i)=>[`var value = ${i.type.storage}(0);`,"",`value += exp(${r.getByIndices("input_indices")});`,"value = log(value);"])},Vs=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceMax",t,(r,i,a)=>{let n=[];for(let s=0;s<r.rank;s++)(a.indexOf(s)>=0||a.length===0)&&n.push(r.indicesSet("input_indices",s,0));return[`${n.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};`,`value = max(value, ${r.getByIndices("input_indices")});`,""]})},Gs=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceMean",t,(r,i,a)=>{let n=1;for(let s=0;s<r.rank;s++)(a.indexOf(s)>=0||a.length===0)&&(n*=e.inputs[0].dims[s]);return["var sum = f32(0);","",`sum += f32(${r.getByIndices("input_indices")});`,`let value = ${i.type.value}(sum / ${n});`]})},Hs=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceMin",t,(r,i,a)=>{let n=[];for(let s=0;s<r.rank;s++)(a.indexOf(s)>=0||a.length===0)&&n.push(`input_indices[${s}] = 0;`);return[`${n.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};`,`value = min(value, ${r.getByIndices("input_indices")});`,""]})},Fs=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceProd",t,(r,i)=>[`var value = ${i.type.storage}(1);`,"",`value *= ${r.getByIndices("input_indices")};`,""])},js=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceSum",t,(r,i)=>[`var value = ${i.type.storage}(0);`,"",`value += ${r.getByIndices("input_indices")};`,""])},Ks=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceSumSquare",t,(r,i)=>[`var t = ${i.type.value}(0); var value = ${i.type.value}(0);`,"",`t = ${r.getByIndices("input_indices")}; value += t * t;`,""])},He=(e,t,r)=>{if(t.length===0)return r;let i=1,a=1;for(let n=0;n<t.length;n++)t.indexOf(n)===-1?i*=e[n]:a*=e[n];return a<32&&i>1024},Zs=(e,t)=>{He(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Gs(e,t):Es(e,t)},Qs=(e,t)=>{He(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?qs(e,t):zs(e,t)},Xs=(e,t)=>{He(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Ws(e,t):Cs(e,t)},Ys=(e,t)=>{He(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Ls(e,t):Os(e,t)},Js=(e,t)=>{He(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Vs(e,t):As(e,t)},eo=(e,t)=>{He(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Hs(e,t):Bs(e,t)},to=(e,t)=>{He(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Fs(e,t):Rs(e,t)},ro=(e,t)=>{He(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?js(e,t):Ms(e,t)},io=(e,t)=>{He(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Ks(e,t):Ns(e,t)},ao=(e,t)=>{He(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Us(e,t):Ds(e,t)}}),Oi,no,so,Ai,sh=P(()=>{J(),we(),Ci(),Oi=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},no=(e,t)=>{Oi(e.inputs);let r=(i,a,n)=>{let s=[];for(let u=0;u<i.rank;u++)(n.indexOf(u)>=0||n.length===0)&&s.push(`input_indices[${u}] = 0;`);return[`${s.join(`
...
var best_index : i32 = 0;`,`if (${i.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},wo=e=>{yo(e.inputs),e.compute(bo(e.inputs))}}),$o,de,vo,xo,ko,So,To,Io,Eo,zo,Co,Oo,Ao,Bo,Ro,Mo,Gt,No,br,Do,Po,Uo,qo,Wo,Lo,Vo,Go,Ho,Fo,jo,Ko,Zo,Qo,Xo,Yo,Ri,Jo,Mi,Ni,eu,tu,ru,iu,au,nu,Di=P(()=>{J(),re(),we(),ne(),$o=(e,t,r,i,a,n,s)=>{let u=Math.ceil(t/4),l="";typeof a=="string"?l=`${a}(a)`:l=a("a");let d=B("inputData",r,[u],4),c=G("outputData",i,[u],4),f=[{name:"vec_size",type:"u32"}];return s&&f.push(...s),`
  ...
  }`},de=(e,t,r,i,a,n=e.dataType,s,u)=>{let l=[{type:12,data:Math.ceil(C.size(e.dims)/4)}];return s&&l.push(...s),{name:t,shaderCache:{hint:a,inputDependencies:["type"]},getShaderSource:d=>$o(d,C.size(e.dims),e.dataType,n,r,i,u),getRunData:d=>({outputs:[{dims:e.dims,dataType:n}],dispatchGroup:{x:Math.ceil(C.size(d[0].dims)/64/4)},programUniforms:l})}},vo=e=>{e.compute(de(e.inputs[0],"Abs","abs"))},xo=e=>{e.compute(de(e.inputs[0],"Acos","acos"))},ko=e=>{e.compute(de(e.inputs[0],"Acosh","acosh"))},So=e=>{e.compute(de(e.inputs[0],"Asin","asin"))},To=e=>{e.compute(de(e.inputs[0],"Asinh","asinh"))},Io=e=>{e.compute(de(e.inputs[0],"Atan","atan"))},Eo=e=>{e.compute(de(e.inputs[0],"Atanh","atanh"))},zo=e=>ce(e),Co=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(de(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},Oo=e=>{let t,r,i=e.length>=2&&e[1].data!==0,a=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=i?e[1].getFloat32Array()[0]:-34028234663852886e22,r=a?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=i?e[1].getUint16Array()[0]:64511,r=a?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return ce({min:t,max:r})},Ao=(e,t)=>{let r=t||Oo(e.inputs),i=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"Clip",a=>`clamp(${a}, vec4<${i}>(uniforms.min), vec4<${i}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:e.inputs[0].dataType,data:r.min},{type:e.inputs[0].dataType,data:r.max}],[{name:"min",type:i},{name:"max",type:i}]),{inputs:[0]})},Bo=e=>{e.compute(de(e.inputs[0],"Ceil","ceil"))},Ro=e=>{e.compute(de(e.inputs[0],"Cos","cos"))},Mo=e=>{e.compute(de(e.inputs[0],"Cosh","cosh"))},Gt=e=>ce(e),No=(e,t)=>{let r=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"Elu",i=>`elu_vf32(${i})`,`
...
}`,Do=e=>{let t=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,br(t)))},Po=e=>{e.compute(de(e.inputs[0],"Exp","exp"))},Uo=e=>{e.compute(de(e.inputs[0],"Floor","floor"))},qo=e=>{let t=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,br(t)))},Wo=(e,t)=>{let r=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"LeakyRelu",i=>`select(leaky_relu_alpha_ * ${i}, ${i}, ${i} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},Lo=e=>{e.compute(de(e.inputs[0],"Not",t=>`!${t}`))},Vo=e=>{e.compute(de(e.inputs[0],"Neg",t=>`-${t}`))},Go=e=>{e.compute(de(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Ho=e=>{let t=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},Fo=e=>{e.compute(de(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},jo=e=>ce(e),Ko=(e,t)=>{let r=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"HardSigmoid",i=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${i} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},Zo=e=>{e.compute(de(e.inputs[0],"Sin","sin"))},Qo=e=>{e.compute(de(e.inputs[0],"Sinh","sinh"))},Xo=e=>{e.compute(de(e.inputs[0],"Sqrt","sqrt"))},Yo=e=>{e.compute(de(e.inputs[0],"Tan","tan"))},Ri=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Jo=e=>{e.compute(de(e.inputs[0],"Tanh",Ri))},Mi=(e="f32")=>`
...
`,au=e=>`quick_gelu_impl(${e})`,nu=(e,t)=>{let r=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"QuickGelu",au,iu(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),su,ou,uu,lh=P(()=>{re(),ne(),Di(),su=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},ou=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=B("input",e[0].dataType,e[0].dims,4),i=B("bias",e[0].dataType,[e[0].dims[2]],4),a=G("output",e[0].dataType,t,4),n=C.size(t)/4,s=ke(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${a.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${$}
      }`},du=(e,t,r,i,a,n,s=r.dataType)=>{let u=r.dims.map(b=>Number(b)??1),l=i.dims.map(b=>Number(b)??1),d=!C.areEqual(u,l),c=u,f=C.size(u),h=!1,g=!1,_=[d];if(d){let b=zt.calcShape(u,l,!1);if(!b)throw new Error("Can't perform binary op on the given tensors");c=b.slice(),f=C.size(c);let k=C.size(u)===1,$=C.size(l)===1,w=u.length>0&&u[u.length-1]%4===0,S=l.length>0&&l[l.length-1]%4===0;_.push(k),_.push($),_.push(w),_.push(S);let x=1;for(let T=1;T<c.length;T++){let z=u[u.length-T],E=l[l.length-T];if(z===E)x*=z;else break}x%4===0?(g=!0,h=!0):(k||$||w||S)&&(h=!0)}else h=!0;return _.push(h),{name:e,shaderCache:{hint:t+_.map(b=>b.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:b=>lu(b,u,l,c,h,d,g,a,r.dataType,i.dataType,s,n),getRunData:()=>({outputs:[{dims:c,dataType:s}],dispatchGroup:{x:Math.ceil(f/64/4)},programUniforms:[{type:12,data:Math.ceil(C.size(c)/4)},...Z(u,l,c)]})}},Fe=(e,t,r,i,a,n)=>{e.compute(du(t,a??"",e.inputs[0],e.inputs[1],r,i,n))},pu=e=>{Fe(e,"Add",(t,r)=>`${t}+${r}`)},cu=e=>{Fe(e,"Div",(t,r)=>`${t}/${r}`)},fu=e=>{Fe(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},hu=e=>{Fe(e,"Mul",(t,r)=>`${t}*${r}`)},mu=e=>{let t=B("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Fe(e,"Pow",{scalar:(r,i)=>`pow_custom(${r},${i})`,vector:(r,i)=>`pow_vector_custom(${r},${i})`},`
...
`},qi=(e,t,r,i,a=!1,n)=>{let s=e[0].dims,u=e[1].dims,l=s[s.length-2],d=u[u.length-1],c=s[s.length-1],f=be(d),h=be(c),g=be(l),_=C.size(r)/f/g,b=e.length>2,k=i?i.slice(0,-2):r.slice(0,-2),$=[C.size(k),l,d],w=[{type:12,data:_},{type:12,data:l},{type:12,data:d},{type:12,data:c}];bt(t,w),w.push(...Z(k,s,u)),b&&w.push(...Z(e[2].dims)),w.push(...Z($));let S=x=>{let T=Ii("batch_dims",e[0].dataType,k.length),z=B("a",e[0].dataType,s.length,h),E=B("b",e[1].dataType,u.length,f),A=G("output",e[0].dataType,$.length,f),N=ke(A.type.tensor),L=yt(t,A.type.value,N),Y=[z,E],F="";if(b){let ie=a?f:1;Y.push(B("bias",e[2].dataType,e[2].dims.length,ie)),F=`${a?`value += bias[col / ${ie}];`:`value += ${A.type.value}(bias[row + i]);`}`}let ee=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];wt(t,ee);let U=()=>{let ie=`var a_data: ${z.type.value};`;for(let Q=0;Q<h;Q++)ie+=`
...
`}return ie};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${f};${h};${g};${a}`,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:n?n(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:w}),getShaderSource:S}}}),zu,Cu,Li,Vi,Ou,Gi,Au,wr,Hi=P(()=>{J(),re(),ne(),$t(),Wi(),Ui(),zu=(e,t)=>e?`
...
`},Au=(e,t,r,i,a=!1)=>{let[n,s,u,l]=i,d=ke(i[0].type.tensor);return`
  ...
  ${b?Li(k,$,Q,ie):Gi(k,$,Q,ie)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${T}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${b?`vec4<${j}>`:j}) {
        ...
        ${ue}
        ${Bu(d,N,L,Y,s,t,F[0],F[1],F[2],j)}
        ${b?Li(S,w,j,void 0,!d,A):Gi(S,w,j,void 0,!d,A,!1,void 0,u)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${T};${b};${N};${L};${Y};${z};${E};${A}`,inputDependencies:U},getRunData:()=>({outputs:[{dims:l?l(r):r,dataType:e[0].dataType}],dispatchGroup:{x:x[0],y:x[1],z:x[2]},programUniforms:ee}),getShaderSource:ie}}}),Mu,Fi,Ft,Nu,ji,Du,Pu,Uu,hh=P(()=>{J(),Je(),re(),ne(),$t(),Ui(),Mu=e=>{let t=1;for(let r=0;r<e.length;r++)t*=e[r];return t},Fi=e=>typeof e=="number"?[e,e,e]:e,Ft=(e,t)=>t<=1?e:e+(e-1)*(t-1),Nu=(e,t,r,i=1)=>{let a=Ft(t,i);return Math.floor((e[0]*(r-1)-r+a)/2)},ji=(e,t,r,i,a)=>{a==null&&(a=Nu(e,t[0],i[0]));let n=[0,0,0,r];for(let s=0;s<3;s++)e[s]+2*a>=t[s]&&(n[s]=Math.trunc((e[s]-t[s]+2*a)/i[s]+1));return n},Du=(e,t,r,i,a,n,s,u,l,d)=>{let c,f,h,g;if(e==="VALID"&&(e=0),typeof e=="number"){c={top:e,bottom:e,left:e,right:e,front:e,back:e};let _=ji([t,r,i,1],[u,l,d],1,[a,n,s],e);f=_[0],h=_[1],g=_[2]}else if(Array.isArray(e)){if(!e.every((b,k,$)=>b===$[0]))throw Error(`Unsupported padding parameter: ${e}`);c={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let _=ji([t,r,i,1],[u,l,d],1,[a,n,s],e[0]);f=_[0],h=_[1],g=_[2]}else if(e==="SAME_UPPER"){f=Math.ceil(t/a),h=Math.ceil(r/n),g=Math.ceil(i/s);let _=(f-1)*a+u-t,b=(h-1)*n+l-r,k=(g-1)*s+d-i,$=Math.floor(_/2),w=_-$,S=Math.floor(b/2),x=b-S,T=Math.floor(k/2),z=k-T;c={top:S,bottom:x,left:T,right:z,front:$,back:w}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:c,outDepth:f,outHeight:h,outWidth:g}},Pu=(e,t,r,i,a,n=!1,s="channelsLast")=>{let u,l,d,c,f;if(s==="channelsLast")[u,l,d,c,f]=e;else if(s==="channelsFirst")[u,f,l,d,c]=e;else throw new Error(`Unknown dataFormat ${s}`);let[h,,g,_,b]=t,[k,$,w]=Fi(r),[S,x,T]=Fi(i),z=Ft(g,S),E=Ft(_,x),A=Ft(b,T),{padInfo:N,outDepth:L,outHeight:Y,outWidth:F}=Du(a,l,d,c,k,$,w,z,E,A),ee=n?h*f:h,U=[0,0,0,0,0];return s==="channelsFirst"?U=[u,ee,L,Y,F]:s==="channelsLast"&&(U=[u,L,Y,F,ee]),{batchSize:u,dataFormat:s,inDepth:l,inHeight:d,inWidth:c,inChannels:f,outDepth:L,outHeight:Y,outWidth:F,outChannels:ee,padInfo:N,strideDepth:k,strideHeight:$,strideWidth:w,filterDepth:g,filterHeight:_,filterWidth:b,effectiveFilterDepth:z,effectiveFilterHeight:E,effectiveFilterWidth:A,dilationDepth:S,dilationHeight:x,dilationWidth:T,inShape:e,outShape:U,filterShape:t}},Uu=(e,t,r,i,a,n)=>{let s=n==="channelsLast";s?e[0].dims[3]:e[0].dims[1];let u=[64,1,1],l={x:r.map((k,$)=>$)},d=[Math.ceil(Mu(l.x.map(k=>r[k]))/u[0]),1,1];le("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${d}`);let c=1,f=C.size(r),h=[{type:12,data:f},{type:12,data:i},{type:12,data:a},{type:12,data:t.strides},{type:12,data:t.dilations}];bt(t,h),h.push(...Z(e[0].dims,e[1].dims));let g=["rank","rank"],_=e.length===3;_&&(h.push(...Z(e[2].dims)),g.push("rank")),h.push(...Z(r));let b=k=>{let $=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:i.length},{name:"pads",type:"u32",length:a.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];wt(t,$);let w=1,S=ke(e[0].dataType),x=B("x",e[0].dataType,e[0].dims.length,c),T=B("W",e[1].dataType,e[1].dims.length,w),z=[x,T],E=G("result",e[0].dataType,r.length,w),A="";if(_){let Y=B("bias",e[2].dataType,e[2].dims.length,w);z.push(Y),A+=`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${f}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:g}),getShaderSource:b}},Wu=(e,t,r,i)=>{let a=e.length>2,n=be(r[3]),s=be(r[2]),u=C.size(r)/n/s,l=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/n],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/n],c=[r[0],r[1],r[2],r[3]/n],f=[{type:12,data:u},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];bt(t,f),f.push(...Z(l,d,c));let h=(s-1)*t.strides[1]+d[1],g=_=>{let b=G("output",e[0].dataType,c.length,n),k=ke(b.type.tensor),$=yt(t,b.type.value,k),w=B("x",e[0].dataType,l.length,n),S=B("w",e[1].dataType,d.length,n),x=[w,S];a&&x.push(B("b",e[2].dataType,e[2].dims,n));let T=a?"value += b[output_channel];":"",z=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return wt(t,z),`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${n};${s};${h};${d[0]};${d[1]}`,inputDependencies:a?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:f}),getShaderSource:g}}}),Lu,$r,Vu,vr,Ki,Zi,Gu,Hu,Qi,gh=P(()=>{re(),fh(),hh(),Hi(),mh(),$t(),Wi(),nt(),Lu=(e,t,r,i,a,n)=>{let s=e[0],u=e.slice(n?1:2,n?3:4),l=u.length,d=t[0],c=t.slice(2).map((h,g)=>h+(h-1)*(r[g]-1)),f=u.map((h,g)=>h+i[g]+i[g+l]).map((h,g)=>Math.floor((h-c[g]+a[g])/a[g]));return f.splice(0,0,s),f.splice(n?3:1,0,d),f},$r=[2,3,1,0],Vu=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],i=e[1].dims[1]*t.group;if(r!==i)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let a=e[0].dims.length-2;if(t.dilations.length!==a)throw new Error(`dilations should be ${a}D`);if(t.strides.length!==a)throw new Error(`strides should be ${a}D`);if(t.pads.length!==a*2)throw new Error(`pads should be ${a*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},vr=(e,t)=>{let r=e.kernelShape.slice();r.length<t[1].dims.length-2&&r.push(...Array(t[1].dims.length-2-r.length).fill(0));for(let n=2;n<t[1].dims.length;++n)r[n-2]===0&&(r[n-2]=t[1].dims[n]);let i=e.pads.slice();fr.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,i,e.format==="NHWC",e.autoPad);let a=Object.assign({},e);return Object.assign(a,{kernelShape:r,pads:i}),a},Ki=e=>{let t=Pi(e),r=e.format,i=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],a=e.dilations,n=e.group,s=e.kernel_shape,u=e.pads,l=e.strides,d=e.w_is_const();return{autoPad:i,format:r,dilations:a,group:n,kernelShape:s,pads:u,strides:l,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},Zi=(e,t,r,i)=>{let a=r.format==="NHWC",n=Lu(t[0].dims,t[1].dims,r.dilations,r.pads,r.strides,a);if(r.group!==1){let z=[t[0]];if(a){let E=e.kernelCustomData.wT??e.compute(Be(t[1],$r),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=E),z.push(E)}else z.push(t[1]);t.length===3&&z.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&a&&t[1].dims[0]===r.group&&t[1].dims[1]===1&&r.dilations[0]===1&&r.dilations[1]===1?e.compute(Wu(z,r,n,i),{inputs:z}):e.compute(qu(z,r,n,i),{inputs:z});return}let s=t.length===3,u=t[0].dims[a?1:2],l=t[0].dims[a?2:3],d=t[0].dims[a?3:1],c=t[1].dims[2],f=t[1].dims[3],h=n[a?1:2],g=n[a?2:3],_=n[a?3:1],b=a&&c===u&&f===l&&r.pads[0]===0&&r.pads[1]===0;if(b||c===1&&f===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let z=n[0],E,A,N,L=[];if(a){let ee=e.kernelCustomData.wT??e.compute(Be(t[1],$r),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=ee),b){let U=u*l*d;E=t[0].reshape([1,z,U]),A=ee.reshape([1,U,_]),N=[1,z,_]}else E=t[0].reshape([z,u*l,d]),A=ee.reshape([1,d,_]),N=[z,h*g,_];L.push(E),L.push(A)}else E=t[0].reshape([z,d,u*l]),A=t[1].reshape([1,_,d]),N=[z,_,h*g],L.push(A),L.push(E);s&&L.push(t[2]);let Y=N[2],F=L[0].dims[L[0].dims.length-1];Y<8&&F<8?e.compute(qi(L,r,n,N,a,i),{inputs:L}):e.compute(wr(L,r,n,N,a,i),{inputs:L});return}let k=!0,$=e.kernelCustomData.wT??e.compute(Be(t[1],$r),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=$);let w=[t[0],$];s&&w.push(t[2]);let S=a?h*g:_,x=a?_:h*g,T=c*f*d;e.compute(Ru(w,r,n,S,x,T,s,k,i),{inputs:w})},Gu=(e,t)=>{let r=t.format==="NHWC",i=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&i.push(e.inputs[2]);let a=[0,t.pads[0],0,t.pads[1]],n=[1].concat(t.strides),s=[1].concat(t.dilations),u=[1].concat(t.kernelShape),l=vr({...t,pads:a,strides:n,dilations:s,kernelShape:u},i);Zi(e,i,l,d=>r?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},Hu=(e,t,r)=>{let i=r.format==="NHWC"?"channelsLast":"channelsFirst",a=vr(r,t),n=r.autoPad==="NOTSET"?r.pads:r.autoPad,s=Pu(t[0].dims,t[1].dims,r.strides,r.dilations,n,!1,i);e.compute(Uu(t,a,s.outShape,[s.filterDepth,s.filterHeight,s.filterWidth],[s.padInfo.front,s.padInfo.top,s.padInfo.left],i))},Qi=(e,t)=>{if(Vu(e.inputs,t),e.inputs[0].dims.length===3)Gu(e,t);else if(e.inputs[0].dims.length===5)Hu(e,e.inputs,t);else{let r=vr(t,e.inputs);Zi(e,e.inputs,r)}}}),Fu,_h=P(()=>{J(),Je(),re(),ne(),Fu=(e,t,r)=>{let i=e.length>2,a=t.outputShape,n=t.format==="NHWC",s=t.group,u=e[1].dims,l=u[2]/s,d=u[3],c=n?be(l):1,f=n&&d===1&&l>=4,h=f?Math.floor(l/4)*4:Math.floor(l/c)*c,g=l-h,_=n?be(d):1,b=n?d===1?c:_:1,k=C.size(a)/_,$=[Math.ceil(k/64),1,1];le("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${$}`);let w=["rank","rank"],S=[t.strides[0],t.strides[1]],x=[t.kernelShape[n?1:2],t.kernelShape[n?2:3]],T=[t.dilations[0],t.dilations[1]],z=[x[0]+(t.dilations[0]<=1?0:(t.kernelShape[n?1:2]-1)*(t.dilations[0]-1)),x[1]+(t.dilations[1]<=1?0:(t.kernelShape[n?2:3]-1)*(t.dilations[1]-1))],E=[z[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),z[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],A=[{type:12,data:k},{type:12,data:S},{type:12,data:x},{type:12,data:T},{type:12,data:z},{type:6,data:E},{type:12,data:h},{type:12,data:l},{type:12,data:d},...Z(e[0].dims,e[1].dims)];i&&(A.push(...Z(e[2].dims)),w.push("rank")),A.push(...Z(a));let N=L=>{let Y=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:S.length},{name:"filter_dims",type:"u32",length:x.length},{name:"dilations",type:"u32",length:x.length},{name:"effective_filter_dims",type:"u32",length:z.length},{name:"pads",type:"i32",length:E.length},{name:"input_channels_per_group_int",type:"u32"},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],F=ke(e[0].dataType),ee=n?1:2,U=n?2:3,ie=n?3:1,Q=B("W",e[1].dataType,e[1].dims.length,b),V=B("Dy",e[0].dataType,e[0].dims.length,c),oe=[V,Q];i&&oe.push(B("bias",e[2].dataType,[a[ie]].length,_));let j=G("result",e[0].dataType,a.length,_),ue=()=>{let te="";if(f)c===4?te+=`
...
`)};
    ...
    ${_}`},c=[{type:12,data:l},...Z(t,i)];return{name:"Expand",shaderCache:{hint:`${i.length};${s}${u}`,inputDependencies:["rank"]},getShaderSource:d,getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:c})}},yl=e=>{ml(e.inputs),e.compute(_l(e.inputs),{inputs:[0]})}}),bl,wl,xh=P(()=>{J(),re(),ne(),Di(),bl=e=>{let t=e[0].dataType,r=C.size(e[0].dims),i=C.size(e[1].dims),a=i%4===0,n=s=>{let u=B("x",t,[1],4),l=B("bias",t,[1],4),d=G("y",t,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],f=g=>`
  ...
  ${h.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((g,_)=>_!==1).map(g=>g.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(g,_)=>"rank")},getRunData:()=>({outputs:[{dims:u,dataType:d}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:f}),getShaderSource:h}},Cl=(e,t)=>{let r=e.inputs;El(r,t),e.compute(zl(e.inputs,t))},Ol=e=>ce({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),Al,Bl,Rl,Ml,Ih=P(()=>{J(),re(),we(),ne(),Al=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
...
`,Fl=(e,t,r)=>(()=>{switch(r.mode){case"nearest":return`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:c},{inputs:[t,r],outputs:[-1]})[0]},Kt=(e,t,r,i,a,n,s,u)=>{let l=n;if(s&&C.size(s.dims)>0){if(i===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return l=Yl(e,n,s,t,i,r*a,u),l=l.reshape([t,i,r,a]),r===1||i===1?l:e.compute(Be(l,ra.perm),{inputs:[l],outputs:[-1]})[0]}else return n.dims.length===3&&(l=n.reshape([t,i,r,a])),r===1||i===1?l:e.compute(Be(l,ra.perm),{inputs:[l],outputs:[-1]})[0]},Jl=(e,t)=>{let r=Ql(e.inputs,t),i=e.inputs[0],a=Ee(e.inputs,1),n=Ee(e.inputs,2),s=Ee(e.inputs,3),u=Ee(e.inputs,4),l=Ee(e.inputs,5),d=Ee(e.inputs,6),c=Ee(e.inputs,7);if(i.dims.length===5)throw new Error("Packed QKV is not implemented");if(a?.dims.length===5)throw new Error("Packed KV is not implemented");let f=a&&n&&a.dims.length===4&&n.dims.length===4,h=Kt(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,i,s,0);if(f)return Vt(e,h,a,n,u,void 0,d,c,l,r);if(!a||!n)throw new Error("key and value must be provided");let g=Kt(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,a,s,r.hiddenSize),_=Kt(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,n,s,2*r.hiddenSize);Vt(e,h,g,_,u,void 0,d,c,l,r)}}),td,rd,id,ad,ia,nd,sd,od=P(()=>{J(),re(),we(),ne(),td=e=>{if(!e||e.length<1)throw new Error("too few inputs")},rd=(e,t)=>{let r=[],i=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(a=>r.push(Number(a))),i=r.length),ce({numOutputs:i,axis:t.axis,splitSizes:r})},id=e=>`
...
`)}
  ...
  }`};e.compute({name:"InstanceNormalization",shaderCache:{hint:`${d}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:a,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:[{type:12,data:c},...Z(h,g,h)]}),getShaderSource:b},{inputs:[t[0],f]})},gd=(e,t,r)=>{let i=t[0].dims,a=i,n=i[0],s=i[i.length-1],u=C.sizeFromDimension(i,1)/s,l=be(s),d=C.size(a)/l,c=[{type:12,data:u},{type:12,data:Math.floor(s/l)}],f=["type","type"],h=!1,g=[0,i.length-1];for(let $=0;$<i.length-2;$++)h=h||i[$+1]!==1,g.push($+1);h=h&&i[i.length-1]!==1;let _=h?e.compute(Be(e.inputs[0],g),{inputs:[e.inputs[0]],outputs:[-1]})[0]:e.inputs[0].reshape(Array.from({length:i.length},($,w)=>i[g[w]])),b=na(e,_,t[1],t[2],n,u,s,r.epsilon),k=$=>{let w=ke(t[0].dataType),S=l===1?"vec2f":`mat${l}x2f`,x=E=>{let A=E===0?"x":"y",N=l===1?"f32":`vec${l}f`;switch(l){case 1:return`${w}(${N}(scale.${A}))`;case 2:return`vec2<${w}>(${N}(scale[0].${A}, scale[1].${A}))`;case 4:return`vec4<${w}>(${N}(scale[0].${A}, scale[1].${A}, scale[2].${A}, scale[3].${A}))`;default:throw new Error(`Not supported compoents ${l}`)}},T=B("input",t[0].dataType,t[0].dims,l),z=G("output",t[0].dataType,a,l);return`
  ...
  ${T.mainStart()}
  ...
  }`},x=[{dims:u,dataType:e[0].dataType}];return $&&x.push({dims:g,dataType:1}),w&&x.push({dims:g,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${_};${r};${i}`,inputDependencies:b},getRunData:()=>({outputs:x,dispatchGroup:{x:Math.ceil(d/64)},programUniforms:k}),getShaderSource:S}},wd=(e,t)=>{yd(e.inputs),e.compute(bd(e.inputs,t,e.outputCount))}}),$d,vd,Bh=P(()=>{re(),Wi(),Hi(),$d=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},vd=e=>{$d(e.inputs);let t=zt.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let r=t[t.length-1],i=e.inputs[0].dims[e.inputs[0].dims.length-1];if(r<8&&i<8)e.compute(qi(e.inputs,{activation:""},t));else{let a=t[t.length-2],n=C.size(e.inputs[0].dims.slice(0,-2)),s=C.size(e.inputs[1].dims.slice(0,-2));if(n!==1&&a===1&&s===1){let u=e.inputs[0].reshape([1,n,i]),l=e.inputs[1].reshape([1,i,r]),d=[1,n,r],c=[u,l];e.compute(wr(c,{activation:""},t,d),{inputs:c})}else e.compute(wr(e.inputs,{activation:""},t))}}}),xd,kd,Sd,Td,Id,Rh=P(()=>{J(),re(),we(),ne(),xd=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let r=e[0],i=r.dims.length;if(r.dims[i-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let a=Math.floor((t.k+t.blockSize-1)/t.blockSize),n=t.blockSize/8*t.bits,s=e[1];if(!C.areEqual(s.dims,[t.n,a,n]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let u=e[2].dims;if(C.size(u)!==t.n*a)throw new Error("scales input size error.");if(e.length===4){let l=e[3].dims,d=t.bits>4?t.n*a:t.n*Math.floor((a+1)/2);if(C.size(l)!==d)throw new Error("zeroPoints input size error.")}},kd=(e,t)=>{let r=e[0].dims,i=r.length,a=r[i-2],n=t.k,s=t.n,u=r.slice(0,i-2),l=C.size(u),d=e[1].dims[2]/4,c=e[0].dataType,f=be(t.k),h=be(d),g=be(s),_=u.concat([a,s]),b=a>1&&s/g%2===0?2:1,k=C.size(_)/g/b,$=64,w=[],S=[l,a,n/f],x=C.convertShape(e[1].dims).slice();x.splice(-1,1,d/h),w.push(...Z(S)),w.push(...Z(x)),w.push(...Z(e[2].dims)),e.length===4&&w.push(...Z(C.convertShape(e[3].dims)));let T=[l,a,s/g];w.push(...Z(T));let z=E=>{let A=S.length,N=B("a",e[0].dataType,A,f),L=B("b",12,x.length,h),Y=B("scales",e[2].dataType,e[2].dims.length),F=[N,L,Y],ee=e.length===4?B("zero_points",12,e[3].dims.length):void 0;ee&&F.push(ee);let U=T.length,ie=G("output",e[0].dataType,U,g),Q=ke(e[0].dataType),V=(()=>{switch(f){case 1:return`array<${Q}, 8>`;case 2:return`mat4x2<${Q}>`;case 4:return`mat2x4<${Q}>`;default:throw new Error(`${f}-component is not supported.`)}})(),oe=()=>{let M=`
          // reuse a data
    ...
    `,u="",l=B("x",t.dataType,t.dims.length),d=["rank"],[c,f,h,g,_]=oa(n,a);return c.push(...Z(t.dims,n)),{name:e,shaderCache:{hint:`${i.cacheKey};${h};${g};${_}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:n,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(C.size(n)/64)},programUniforms:c}),getShaderSource:b=>ua(b,l,t.dims.length,n.length,a,s,u,t.dataType===10?-65504:-1e5,f,h,g,_)}},Vd=(e,t)=>{Zt(e.inputs),e.compute(fa("MaxPool",e.inputs[0],!1,t))},Gd=e=>{let t=e.storage_order,r=e.dilations,i=da(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(i.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let a={storageOrder:t,dilations:r,...i,cacheKey:""};return{...a,cacheKey:Pd(a)}},Hd=e=>{let t=e.format;return{format:t,...ca,cacheKey:t}},Fd=(e,t)=>{Zt(e.inputs),e.compute(fa("GlobalMaxPool",e.inputs[0],!0,t))}}),jd,Kd,Zd,Qd,Dh=P(()=>{J(),re(),we(),ne(),jd=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,i)=>r===e[2].dims[i]).reduce((r,i)=>r&&i,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((a,n)=>n===t.axis||a===e[0].dims[n]).reduce((a,n)=>a&&n,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],i=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/i)||t.blockSize>Math.ceil(r/(i-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Kd=(e,t)=>{let r=C.normalizeAxis(t.axis,e[0].dims.length),i=e[0].dataType,a=i===3,n=e[0].dims,s=e[1].dataType,u=C.size(n),l=i===3||i===2,d=l?[Math.ceil(C.size(e[0].dims)/4)]:e[0].dims,c=e[1].dims,f=e.length>2?e[2]:void 0,h=f?l?[Math.ceil(C.size(f.dims)/4)]:f.dims:void 0,g=c.length===0||c.length===1&&c[0]===1,_=g===!1&&c.length===1,b=be(u),k=g&&(!l||b===4),$=k?b:1,w=k&&!l?b:1,S=B("input",l?12:i,d.length,w),x=B("scale",s,c.length),T=f?B("zero_point",l?12:i,h.length):void 0,z=G("output",s,n.length,$),E=[S,x];T&&E.push(T);let A=[d,c];f&&A.push(h);let N=[{type:12,data:u/$},{type:12,data:r},{type:12,data:t.blockSize},...Z(...A,n)],L=Y=>{let F=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:T?["rank","rank","rank"]:["rank","rank"]},getShaderSource:L,getRunData:()=>({outputs:[{dims:n,dataType:s}],dispatchGroup:{x:Math.ceil(u/$/64),y:1,z:1},programUniforms:N})}},Zd=(e,t)=>{jd(e.inputs,t),e.compute(Kd(e.inputs,t))},Qd=e=>ce({axis:e.axis,blockSize:e.blockSize})}),Xd,Yd,Jd,Ph=P(()=>{qe(),J(),ne(),Xd=(e,t,r)=>{let i=e===t,a=e<t&&r<0,n=e>t&&r>0;if(i||a||n)throw new Error("Range these inputs' contents are invalid.")},Yd=(e,t,r,i)=>{let a=Math.abs(Math.ceil((t-e)/r)),n=[a],s=a,u=[{type:12,data:s},{type:i,data:e},{type:i,data:r},...Z(n)],l=d=>{let c=G("output",i,n.length),f=c.type.value,h=[{name:"outputSize",type:"u32"},{name:"start",type:f},{name:"delta",type:f}];return`
        ${d.registerUniforms(h).declareVariables(c)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${f}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${i}`},getShaderSource:l,getRunData:()=>({outputs:[{dims:n,dataType:i}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u})}},Jd=e=>{let t=0,r=0,i=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],i=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],i=e.inputs[2].getFloat32Array()[0]),ge.webgpu.validateInputContent&&Xd(t,r,i),e.compute(Yd(t,r,i,e.inputs[0].dataType),{inputs:[]})}}),ep,ha,ma,tp,rp,ip,Uh=P(()=>{J(),re(),we(),ne(),ep=(e,t,r,i)=>{if(e!=="none"&&i!=="i32"&&i!=="u32"&&i!=="f32")throw new Error(`Input ${i} is not supported with reduction ${e}.`);let a=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,n=`;
    ...
    data_offset += u32((u32(index) * element_count_dim));`,ma=(e,t,r)=>`for (var i = 0u; i < uniforms.num_updates_elements; i++) {
      ...
      }`,tp=(e,t)=>{let r=e[0].dims,i=e[1].dims,a=r,n=1,s=Math.ceil(C.size(i)/n),u=i[i.length-1],l=C.sizeFromDimension(r,u),d=C.sizeFromDimension(i,0)/u,c=[{type:12,data:s},{type:12,data:u},{type:12,data:l},...Z(e[1].dims,e[2].dims,a)],f=h=>{let g=B("indices",e[1].dataType,e[1].dims.length),_=B("updates",e[2].dataType,e[2].dims.length,n),b=t.reduction!=="none"&&t.reduction!==""?us("output",e[0].dataType,a.length):G("output",e[0].dataType,a.length,n);return`
...
`:"",mp=(e,t,r,i,a)=>{let[n,s,u,l]=r.length===2?[-1,0,1,-1]:[0,2,3,1],d=e.type.value;return`
    ...
    }`},gp=(e,t,r,i,a,n,s,u,l,d)=>{let c=r.length===2,[f,h]=c?[0,1]:[2,3],g=e.type.value,_=b=>{let k=b===f?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${g} {
    ...
    }`},yp=(e,t,r,i,a,n)=>{let s=e.dims,u=lp(n,t.axes,s.length),l=dp(s,i,a,t.axes),d=i.slice();i.length===0&&(d=s.map((w,S)=>w===0?1:l[S]/w),t.keepAspectRatioPolicy!=="stretch"&&(l=pp(s,d,t)));let c=G("output",e.dataType,l.length),f=B("input",e.dataType,s.length),h=C.size(l),g=s.length===l.length&&s.every((w,S)=>w===l[S]),_=t.coordinateTransformMode==="tf_crop_and_resize",b=t.extrapolationValue,k=f.type.value,$=w=>`
      ${g?"":`
...
`}
      }`;return{name:"Resize",shaderCache:{hint:`${t.cacheKey}|${r}|${d.length>0?t.mode==="cubic"?d:d.length:""}|${a.length>0?a:""}|${u.length>0?u:""}|${g}|${t.mode==="nearest"?s.length:s}`,inputDependencies:["rank"]},getShaderSource:$,getRunData:()=>({outputs:[{dims:l,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:[{type:12,data:h},{type:1,data:d},{type:1,data:u},...Z(s,l)]})}},bp=e=>{let t=e.customDataBuffer;return new Uint32Array(t,t.byteOffset,1)[0]},wp=(e,t)=>{let r=[],i=[],a=[],n=bp(e);if(t.antialias!==0)throw Error("Only default value (0) for Antialias attribute is supported");sp(e.inputs,t,n,r,i,a),e.compute(yp(e.inputs[0],t,n,r,i,a),{inputs:[0]})},$p=e=>{let t=e.antialias,r=e.axes,i=e.coordinateTransformMode,a=e.cubicCoeffA,n=e.excludeOutside!==0,s=e.extrapolationValue,u=e.keepAspectRatioPolicy,l=e.mode,d=e.nearestMode===""?"simple":e.nearestMode;return ce({antialias:t,axes:r,coordinateTransformMode:i,cubicCoeffA:a,excludeOutside:n,extrapolationValue:s,keepAspectRatioPolicy:u,mode:l,nearestMode:d})}}),vp,xp,kp,Wh=P(()=>{J(),re(),ne(),vp=e=>{if(!e||e.length<3)throw new Error("layerNorm requires at least 3 inputs.");let t=e[0],r=e[1],i=e[2];if(t.dataType!==r.dataType||t.dataType!==i.dataType)throw new Error("All inputs must have the same data type");if(t.dims.length!==3&&t.dims.length!==2)throw new Error("Input must be 2D or 3D");if(r.dims.length!==3&&r.dims.length!==2)throw new Error("Skip must be 2D or 3D");let a=t.dims[t.dims.length-1],n=t.dims[t.dims.length-2];if(r.dims[r.dims.length-1]!==a)throw new Error("Skip must have the same hidden size as input");if(r.dims[r.dims.length-2]!==n)throw new Error("Skip must have the same sequence length as input");if(i.dims.length!==1)throw new Error("Gamma must be 1D");if(i.dims[i.dims.length-1]!==a)throw new Error("Gamma must have the same hidden size as input");if(e.length>3){let s=e[3];if(s.dims.length!==1)throw new Error("Beta must be 1D");if(s.dims[s.dims.length-1]!==a)throw new Error("Beta must have the same hidden size as input")}if(e.length>4){let s=e[4];if(s.dims.length!==1)throw new Error("Bias must be 1D");if(s.dims[s.dims.length-1]!==a)throw new Error("Bias must have the same hidden size as input")}},xp=(e,t,r,i)=>{let a=t.simplified,n=e[0].dims,s=C.size(n),u=n,l=s,d=n.slice(-1)[0],c=i?n.slice(0,-1).concat(1):[],f=!a&&e.length>3,h=e.length>4,g=i&&r>1,_=i&&r>2,b=r>3,k=64,$=be(d),w=[{type:12,data:l},{type:12,data:$},{type:12,data:d},{type:1,data:t.epsilon}],S=T=>{let z=[{name:"output_size",type:"u32"},{name:"components",type:"u32"},{name:"hidden_size",type:"u32"},{name:"epsilon",type:"f32"}],E=[B("x",e[0].dataType,e[0].dims,$),B("skip",e[1].dataType,e[1].dims,$),B("gamma",e[2].dataType,e[2].dims,$)];f&&E.push(B("beta",e[3].dataType,e[3].dims,$)),h&&E.push(B("bias",e[4].dataType,e[4].dims,$)),E.push(G("output",e[0].dataType,u,$)),g&&E.push(G("mean_output",1,c)),_&&E.push(G("inv_std_output",1,c)),b&&E.push(G("input_skip_bias_sum",e[0].dataType,u,$));let A=ke(e[0].dataType),N=ke(1,$);return`
      ...
      ${T.mainStart([k,1,1])}
        ...
        let mean = ${at("sum",$)} / f32(uniforms.hidden_size);
        let inv_std_dev = inverseSqrt(${at("square_sum",$)} / f32(uniforms.hidden_size) ${a?"":"- mean * mean"} + uniforms.epsilon);
      ...
      }`},x=[{dims:u,dataType:e[0].dataType}];return r>1&&x.push({dims:c,dataType:1}),r>2&&x.push({dims:c,dataType:1}),r>3&&x.push({dims:n,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${$};${g};${_};${b}`,inputDependencies:e.map((T,z)=>"type")},getShaderSource:S,getRunData:()=>({outputs:x,dispatchGroup:{x:Math.ceil(l/d)},programUniforms:w})}},kp=(e,t)=>{vp(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(xp(e.inputs,t,e.outputCount,!1),{outputs:r})}}),Sp,Qt,Tp,ya,Ip,Ep,zp,Cp,Lh=P(()=>{J(),re(),we(),ne(),Sp=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,i)=>{if(e[i+1].dataType!==6&&e[i+1].dataType!==7)throw new Error(`Input ${i} must be an array of int32 or int64`)})},Qt=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(i=>r.push(Number(i)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(i=>r.push(Number(i)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Tp=(e,t)=>{if(e.length>1){let r=Qt(e,1),i=Qt(e,2),a=Qt(e,3);return a.length===0&&(a=[...Array(e[0].dims.length).keys()]),ce({starts:r,ends:i,axes:a})}else return t},ya=(e,t,r,i,a)=>{let n=e;return e<0&&(n+=r[i[t]]),a[t]<0?Math.max(0,Math.min(n,r[i[t]]-1)):Math.max(0,Math.min(n,r[i[t]]))},Ip=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${l.length}_${s.length}_${n.length}`,inputDependencies:["rank"]},getShaderSource:k,getRunData:()=>({outputs:[c],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:b})}},zp=(e,t)=>{Sp(e.inputs,t);let r=Tp(e.inputs,t);e.compute(Ep(e.inputs,r),{inputs:[0]})},Cp=e=>{let t=e.starts,r=e.ends,i=e.axes;return ce({starts:t,ends:r,axes:i})}}),Op,Ap,Bp,Rp,Vh=P(()=>{J(),re(),we(),nt(),ne(),Op=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Ap=(e,t)=>{let r=e.inputs[0],i=r.dims,a=C.size(i),n=i.length,s=C.normalizeAxis(t.axis,n),u=s<i.length-1,l,d=[];u?(d=Array.from({length:n},(E,A)=>A),d[s]=n-1,d[n-1]=s,l=e.compute(Be(r,d),{inputs:[r],outputs:[-1]})[0]):l=r;let c=l.dims,f=c[n-1],h=a/f,g=be(f),_=f/g,b=64;h===1&&(b=256);let k=(E,A)=>A===4?`max(max(${E}.x, ${E}.y), max(${E}.z, ${E}.w))`:A===2?`max(${E}.x, ${E}.y)`:A===3?`max(max(${E}.x, ${E}.y), ${E}.z)`:E,$=B("x",l.dataType,l.dims,g),w=G("result",l.dataType,l.dims,g),S=$.type.value,x=ke(l.dataType)==="f32"?`var threadMax = ${S}(-3.402823e+38f);`:`var threadMax = ${S}(-65504.0h);`,T=E=>`
 ...
 * limitations under the License.
 * =============================================================================
 */let Bt=null;const hc=.2,mc=.4,Jh=1.6,gc=3;self.addEventListener("message",async e=>{const{type:t,data:r}=e.data;switch(t){case"INIT":try{const i=["webgl","wasm"];console.log("Initializing detection model:",r.modelPath),Bt=await jr.create(r.modelPath,{executionProviders:i,graphOptimizationLevel:"all"}),console.log("Detection model initialized successfully"),console.log("Input names:",Bt.inputNames),console.log("Output names:",Bt.outputNames),self.postMessage({type:"RESULT",data:{initialized:!0}})}catch(i){self.postMessage({type:"ERROR",error:i.message})}break;case"PROCESS":if(!Bt){self.postMessage({type:"ERROR",error:"Model not initialized"});return}try{const{imageData:i,width:a,height:n}=r,{resizedWidth:s,resizedHeight:u,ratioW:l,ratioH:d}=em(a,n),c=tm(i,a,n,s,u),f=Bt.inputNames[0]||"x",h={};h[f]=c;const g=await Bt.run(h),_=rm(g,s,u,l,d);self.postMessage({type:"RESULT",data:{boxes:_}})}catch(i){self.postMessage({type:"ERROR",error:i.message})}break}});function em(e,t,r=960){let i=e,a=t;Math.max(e,t)>r&&(e>t?(i=r,a=Math.round(t*r/e)):(a=r,i=Math.round(e*r/t))),i=Math.ceil(i/32)*32,a=Math.ceil(a/32)*32;const n=e/i,s=t/a;return{resizedWidth:i,resizedHeight:a,ratioW:n,ratioH:s}}function tm(e,t,r,i,a){const s=new OffscreenCanvas(i,a).getContext("2d"),u=new ImageData(new Uint8ClampedArray(e),t,r),l=new OffscreenCanvas(t,r);l.getContext("2d").putImageData(u,0,0),s.drawImage(l,0,0,t,r,0,0,i,a);const c=s.getImageData(0,0,i,a).data,f=[.485,.456,.406],h=[.229,.224,.225],g=new Float32Array(3*i*a);for(let _=0;_<a;_++)for(let b=0;b<i;b++){const k=(_*i+b)*4,$=_*i+b;g[$]=(c[k]/255-f[0])/h[0],g[a*i+$]=(c[k+1]/255-f[1])/h[1],g[2*a*i+$]=(c[k+2]/255-f[2])/h[2]}return new Pe("float32",g,[1,3,a,i])}function rm(e,t,r,i,a){const n=Object.keys(e)[0];console.log("Detection output name:",n);const s=e[n];if(!s)return console.error("No output found in results. Available outputs:",Object.keys(e)),[];console.log("Output shape:",s.dims),console.log("Output data length:",s.data.length);const u=s.data,[,,l,d]=s.dims,c=new Uint8Array(l*d);let f=0,h=0,g=1;for(let $=0;$<u.length;$++){const w=u[$];h=Math.max(h,w),g=Math.min(g,w),w>hc?(c[$]=255,f++):c[$]=0}console.log("Detection probability stats:",{min:g,max:h,threshold:hc,pixelsAboveThreshold:f,totalPixels:u.length,percentageAbove:(f/u.length*100).toFixed(2)+"%"});const _=im(c,d,l);console.log(`Found ${_.length} contours`);const b=[],k={no_rect:0,low_score:0,no_expanded_box:0,too_small:0};for(const $ of _){const w=nm($);if(!w){k.no_rect++;continue}const S=sm(u,w,d,l);if(S<mc){k.low_score++,console.log(`Box rejected: score ${S.toFixed(3)} < threshold ${mc}`);continue}const x=om(w,Jh);if(!x){k.no_expanded_box++;continue}const T=Math.abs(x.topRight.x-x.topLeft.x),z=Math.abs(x.bottomLeft.y-x.topLeft.y);if(Math.min(T,z)<gc){k.too_small++,console.log(`Box rejected: size ${Math.min(T,z).toFixed(1)} < minimum ${gc}`);continue}b.push({topLeft:{x:x.topLeft.x*i,y:x.topLeft.y*a},topRight:{x:x.topRight.x*i,y:x.topRight.y*a},bottomRight:{x:x.bottomRight.x*i,y:x.bottomRight.y*a},bottomLeft:{x:x.bottomLeft.x*i,y:x.bottomLeft.y*a}})}return console.log("Box filtering results:",{totalContours:_.length,acceptedBoxes:b.length,rejectionReasons:k}),b}function im(e,t,r){const i=new Uint8Array(t*r),a=[];for(let n=0;n<r;n++)for(let s=0;s<t;s++){const u=n*t+s;if(e[u]===255&&!i[u]){const l=am(e,i,s,n,t,r);l.length>10&&a.push(l)}}return a}function am(e,t,r,i,a,n){const s=[],u=[{x:r,y:i}],l=[-1,0,1,-1,1,-1,0,1],d=[-1,-1,-1,0,0,1,1,1];for(;u.length>0;){const{x:c,y:f}=u.pop(),h=f*a+c;if(!(c<0||c>=a||f<0||f>=n||t[h]||e[h]!==255)){t[h]=1,s.push({x:c,y:f});for(let g=0;g<8;g++)u.push({x:c+l[g],y:f+d[g]})}}return s}function nm(e){if(e.length<4)return null;let t=1/0,r=1/0,i=-1/0,a=-1/0;for(const n of e)t=Math.min(t,n.x),r=Math.min(r,n.y),i=Math.max(i,n.x),a=Math.max(a,n.y);return{topLeft:{x:t,y:r},topRight:{x:i,y:r},bottomRight:{x:i,y:a},bottomLeft:{x:t,y:a}}}function sm(e,t,r,i){const a=Math.floor(Math.min(t.topLeft.x,t.bottomLeft.x)),n=Math.ceil(Math.max(t.topRight.x,t.bottomRight.x)),s=Math.floor(Math.min(t.topLeft.y,t.topRight.y)),u=Math.ceil(Math.max(t.bottomLeft.y,t.bottomRight.y));let l=0,d=0;for(let c=Math.max(0,s);c<Math.min(i,u);c++)for(let f=Math.max(0,a);f<Math.min(r,n);f++)l+=e[c*r+f],d++;return d>0?l/d:0}function om(e,t){const r=(e.topLeft.x+e.topRight.x+e.bottomLeft.x+e.bottomRight.x)/4,i=(e.topLeft.y+e.topRight.y+e.bottomLeft.y+e.bottomRight.y)/4,a=Math.max(Math.abs(e.topRight.x-e.topLeft.x),Math.abs(e.bottomRight.x-e.bottomLeft.x)),n=Math.max(Math.abs(e.bottomLeft.y-e.topLeft.y),Math.abs(e.bottomRight.y-e.topRight.y)),s=a*t,u=n*t;return{topLeft:{x:r-s/2,y:i-u/2},topRight:{x:r+s/2,y:i-u/2},bottomRight:{x:r+s/2,y:i+u/2},bottomLeft:{x:r-s/2,y:i+u/2}}}})();
