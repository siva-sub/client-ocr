 ...
 * limitations under the License.
 * =============================================================================
 */let zr=null,Yt=[];self.addEventListener("message",async e=>{const{type:t,data:r}=e.data;switch(t){case"INIT":try{if(zr=await Kr.create(r.modelPath,{executionProviders:["wasm"],graphOptimizationLevel:"all"}),r.dictPath)try{Yt=(await(await fetch(r.dictPath)).text()).trim().split(`
