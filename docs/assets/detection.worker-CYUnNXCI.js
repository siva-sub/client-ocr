...
`)}
        }`},getRunData:()=>({outputs:[{dims:l,dataType:n}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:[{type:12,data:_},...Z(d,l)]})}},zi=(e,t)=>{let r=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(i=>r.push(Number(i))),ce({axes:r,keepDims:t.keepDims,noopWithEmptyAxes:t.noopWithEmptyAxes})},Ge=(e,t,r,i)=>{let a=e.inputs,n=a.length===1?r:zi(a,r);e.compute(_r(t,{hint:n.cacheKey,inputDependencies:["rank"]},[a[0]],n.noopWithEmptyAxes&&n.axes.length===0?Ps:i,n.axes,a[0].dataType,n.keepDims,n.noopWithEmptyAxes),{inputs:[0]})},Us=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceLogSum",t,(r,i)=>[`var value = ${i.type.storage}(0);`,"",`value += ${r.getByIndices("input_indices")};`,"value = log(value);"])},qs=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceL1",t,(r,i)=>[`var value = ${i.type.storage}(0);`,"",`value += abs(${r.getByIndices("input_indices")});`,""])},Ls=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceL2",t,(r,i)=>[`var t = ${i.type.value}(0); var value = ${i.type.value}(0);`,"",`t = ${r.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])},Ws=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceLogSumExp",t,(r,i)=>[`var value = ${i.type.storage}(0);`,"",`value += exp(${r.getByIndices("input_indices")});`,"value = log(value);"])},Vs=(e,t)=>{Ve(e.inputs),Ge(e,"ReduceMax",t,(r,i,a)=>{let n=[];for(let s=0;s<r.rank;s++)(a.indexOf(s)>=0||a.length===0)&&n.push(r.indicesSet("input_indices",s,0));return[`${n.join(`
...
var best_index : i32 = 0;`,`if (${i.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`};return{name:"AttentionProbsSoftmax",shaderCache:{hint:`${d};${g};${l}`,inputDependencies:b},getShaderSource:k,getRunData:()=>({outputs:[],dispatchGroup:{x:1,y:a,z:t*r},programUniforms:h})}},lo=(e,t,r,i,a,n,s,u,l)=>{let d=s+n.kvSequenceLength,c=[n.batchSize,n.numHeads,n.sequenceLength,d],f=e>1&&i,h=n.kvNumHeads?n.kvNumHeads:n.numHeads,g=f?[n.batchSize,h,d,n.headSize]:void 0,_=n.nReps?n.nReps:1,b=n.scale===0?1/Math.sqrt(n.headSize):n.scale,k=be(n.headSize),v=n.headSize/k,w=12,S={x:Math.ceil(d/w),y:Math.ceil(n.sequenceLength/w),z:n.batchSize*n.numHeads},x=[{type:12,data:n.sequenceLength},{type:12,data:v},{type:12,data:d},{type:12,data:n.numHeads},{type:12,data:n.headSize},{type:1,data:b},{type:12,data:s},{type:12,data:n.kvSequenceLength},{type:12,data:_}],T=f&&i&&C.size(i.dims)>0,z=["type","type"];T&&z.push("type"),a&&z.push("type"),u&&z.push("type"),l&&z.push("type");let E=[{dims:c,dataType:t.dataType,gpuDataType:0}];f&&E.push({dims:g,dataType:t.dataType,gpuDataType:0});let O=M=>{let W=R("q",t.dataType,t.dims,k),X=R("key",r.dataType,r.dims,k),F=[W,X];if(T){let j=R("past_key",i.dataType,i.dims,k);F.push(j)}a&&F.push(R("attention_bias",a.dataType,a.dims));let ee=u?R("seq_lens",u.dataType,u.dims):void 0;ee&&F.push(ee);let U=l?R("total_sequence_length_input",l.dataType,l.dims):void 0;U&&F.push(U);let ie=G("output",t.dataType,c),Q=[ie];f&&Q.push(G("present_key",t.dataType,g,k));let V=Ie(1,k),oe=[{name:"M",type:"u32"},{name:"K",type:"u32"},{name:"N",type:"u32"},{name:"num_heads",type:"u32"},{name:"head_size",type:"u32"},{name:"alpha",type:"f32"},{name:"past_sequence_length",type:"u32"},{name:"kv_sequence_length",type:"u32"},{name:"n_reps",type:"u32"}];return`
  const TILE_SIZE = ${w}u;
  ...
  }`}},wo=e=>{yo(e.inputs),e.compute(bo(e.inputs))}}),$o,de,vo,xo,ko,So,To,Io,Eo,zo,Co,Oo,Ao,Ro,Bo,Mo,Gt,No,br,Do,Po,Uo,qo,Lo,Wo,Vo,Go,Ho,Fo,jo,Ko,Zo,Xo,Qo,Yo,Bi,Jo,Mi,Ni,eu,tu,ru,iu,au,nu,Di=P(()=>{J(),re(),we(),ne(),$o=(e,t,r,i,a,n,s)=>{let u=Math.ceil(t/4),l="";typeof a=="string"?l=`${a}(a)`:l=a("a");let d=R("inputData",r,[u],4),c=G("outputData",i,[u],4),f=[{name:"vec_size",type:"u32"}];return s&&f.push(...s),`
  ...
  }`},de=(e,t,r,i,a,n=e.dataType,s,u)=>{let l=[{type:12,data:Math.ceil(C.size(e.dims)/4)}];return s&&l.push(...s),{name:t,shaderCache:{hint:a,inputDependencies:["type"]},getShaderSource:d=>$o(d,C.size(e.dims),e.dataType,n,r,i,u),getRunData:d=>({outputs:[{dims:e.dims,dataType:n}],dispatchGroup:{x:Math.ceil(C.size(d[0].dims)/64/4)},programUniforms:l})}},vo=e=>{e.compute(de(e.inputs[0],"Abs","abs"))},xo=e=>{e.compute(de(e.inputs[0],"Acos","acos"))},ko=e=>{e.compute(de(e.inputs[0],"Acosh","acosh"))},So=e=>{e.compute(de(e.inputs[0],"Asin","asin"))},To=e=>{e.compute(de(e.inputs[0],"Asinh","asinh"))},Io=e=>{e.compute(de(e.inputs[0],"Atan","atan"))},Eo=e=>{e.compute(de(e.inputs[0],"Atanh","atanh"))},zo=e=>ce(e),Co=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(de(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},Oo=e=>{let t,r,i=e.length>=2&&e[1].data!==0,a=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=i?e[1].getFloat32Array()[0]:-34028234663852886e22,r=a?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=i?e[1].getUint16Array()[0]:64511,r=a?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return ce({min:t,max:r})},Ao=(e,t)=>{let r=t||Oo(e.inputs),i=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"Clip",a=>`clamp(${a}, vec4<${i}>(uniforms.min), vec4<${i}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:e.inputs[0].dataType,data:r.min},{type:e.inputs[0].dataType,data:r.max}],[{name:"min",type:i},{name:"max",type:i}]),{inputs:[0]})},Ro=e=>{e.compute(de(e.inputs[0],"Ceil","ceil"))},Bo=e=>{e.compute(de(e.inputs[0],"Cos","cos"))},Mo=e=>{e.compute(de(e.inputs[0],"Cosh","cosh"))},Gt=e=>ce(e),No=(e,t)=>{let r=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"Elu",i=>`elu_vf32(${i})`,`
...
}`,Do=e=>{let t=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,br(t)))},Po=e=>{e.compute(de(e.inputs[0],"Exp","exp"))},Uo=e=>{e.compute(de(e.inputs[0],"Floor","floor"))},qo=e=>{let t=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,br(t)))},Lo=(e,t)=>{let r=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"LeakyRelu",i=>`select(leaky_relu_alpha_ * ${i}, ${i}, ${i} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},Wo=e=>{e.compute(de(e.inputs[0],"Not",t=>`!${t}`))},Vo=e=>{e.compute(de(e.inputs[0],"Neg",t=>`-${t}`))},Go=e=>{e.compute(de(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Ho=e=>{let t=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},Fo=e=>{e.compute(de(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},jo=e=>ce(e),Ko=(e,t)=>{let r=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"HardSigmoid",i=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${i} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},Zo=e=>{e.compute(de(e.inputs[0],"Sin","sin"))},Xo=e=>{e.compute(de(e.inputs[0],"Sinh","sinh"))},Qo=e=>{e.compute(de(e.inputs[0],"Sqrt","sqrt"))},Yo=e=>{e.compute(de(e.inputs[0],"Tan","tan"))},Bi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Jo=e=>{e.compute(de(e.inputs[0],"Tanh",Bi))},Mi=(e="f32")=>`
...
`,au=e=>`quick_gelu_impl(${e})`,nu=(e,t)=>{let r=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"QuickGelu",au,iu(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),su,ou,uu,uh=P(()=>{re(),ne(),Di(),su=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},ou=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=R("input",e[0].dataType,e[0].dims,4),i=R("bias",e[0].dataType,[e[0].dims[2]],4),a=G("output",e[0].dataType,t,4),n=C.size(t)/4,s=ke(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${a.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${v}
      }`},du=(e,t,r,i,a,n,s=r.dataType)=>{let u=r.dims.map(b=>Number(b)??1),l=i.dims.map(b=>Number(b)??1),d=!C.areEqual(u,l),c=u,f=C.size(u),h=!1,g=!1,_=[d];if(d){let b=zt.calcShape(u,l,!1);if(!b)throw new Error("Can't perform binary op on the given tensors");c=b.slice(),f=C.size(c);let k=C.size(u)===1,v=C.size(l)===1,w=u.length>0&&u[u.length-1]%4===0,S=l.length>0&&l[l.length-1]%4===0;_.push(k),_.push(v),_.push(w),_.push(S);let x=1;for(let T=1;T<c.length;T++){let z=u[u.length-T],E=l[l.length-T];if(z===E)x*=z;else break}x%4===0?(g=!0,h=!0):(k||v||w||S)&&(h=!0)}else h=!0;return _.push(h),{name:e,shaderCache:{hint:t+_.map(b=>b.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:b=>lu(b,u,l,c,h,d,g,a,r.dataType,i.dataType,s,n),getRunData:()=>({outputs:[{dims:c,dataType:s}],dispatchGroup:{x:Math.ceil(f/64/4)},programUniforms:[{type:12,data:Math.ceil(C.size(c)/4)},...Z(u,l,c)]})}},Fe=(e,t,r,i,a,n)=>{e.compute(du(t,a??"",e.inputs[0],e.inputs[1],r,i,n))},pu=e=>{Fe(e,"Add",(t,r)=>`${t}+${r}`)},cu=e=>{Fe(e,"Div",(t,r)=>`${t}/${r}`)},fu=e=>{Fe(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},hu=e=>{Fe(e,"Mul",(t,r)=>`${t}*${r}`)},mu=e=>{let t=R("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Fe(e,"Pow",{scalar:(r,i)=>`pow_custom(${r},${i})`,vector:(r,i)=>`pow_vector_custom(${r},${i})`},`
...
`)},ku=(e,t,r,i)=>{let a=C.size(r),n=new Array(e.length),s=new Array(e.length),u=0,l=[],d=[],c=[{type:12,data:a}];for(let b=0;b<e.length;++b)u+=e[b].dims[t],n[b]=u,d.push(e[b].dims.length),s[b]=R(`input${b}`,i,d[b]),l.push("rank"),c.push({type:12,data:n[b]});for(let b=0;b<e.length;++b)c.push(...Z(e[b].dims));c.push(...Z(r));let f=G("output",i,r.length),h=f.indicesGet("indices",t),g=Array.from(Array(n.length).keys()).map(b=>`uniforms.sizeInConcatAxis${b}`).join(","),_=b=>`
...
`}),Ht,qi,Li=P(()=>{J(),re(),ne(),$t(),Ht=(e,t,r,i,a)=>{let n=i-r;return`
...
`}return ie};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${f};${h};${g};${a}`,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:n?n(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:w}),getShaderSource:S}}}),zu,Cu,Wi,Vi,Ou,Gi,Au,wr,Hi=P(()=>{J(),re(),ne(),$t(),Li(),Ui(),zu=(e,t)=>e?`
        ...
        }`,Wi=(e,t,r="f32",i,a=!1,n=32,s=!1,u=32)=>{let l=t[1]*e[1],d=t[0]*e[0],c=a?l:n,f=a?n:l,h=c/t[0],g=n/t[1];if(!((a&&h===4&&e[1]===4||!a&&(h===3||h===4))&&c%t[0]===0&&n%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${a} is true, innerElementSize ${h} and workPerThread[1] ${e[1]} must be 4.
...
`},Au=(e,t,r,i,a=!1)=>{let[n,s,u,l]=i,d=ke(i[0].type.tensor);return`
  ...
  ${b?Wi(k,v,Q,ie):Gi(k,v,Q,ie)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${T}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${b?`vec4<${j}>`:j}) {
        ...
        ${b?Wi(S,w,j,void 0,!d,O):Gi(S,w,j,void 0,!d,O,!1,void 0,u)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${T};${b};${M};${W};${X};${z};${E};${O}`,inputDependencies:U},getRunData:()=>({outputs:[{dims:l?l(r):r,dataType:e[0].dataType}],dispatchGroup:{x:x[0],y:x[1],z:x[2]},programUniforms:ee}),getShaderSource:ie}}}),Mu,Fi,Ft,Nu,ji,Du,Pu,Uu,fh=P(()=>{J(),Je(),re(),ne(),$t(),Ui(),Mu=e=>{let t=1;for(let r=0;r<e.length;r++)t*=e[r];return t},Fi=e=>typeof e=="number"?[e,e,e]:e,Ft=(e,t)=>t<=1?e:e+(e-1)*(t-1),Nu=(e,t,r,i=1)=>{let a=Ft(t,i);return Math.floor((e[0]*(r-1)-r+a)/2)},ji=(e,t,r,i,a)=>{a==null&&(a=Nu(e,t[0],i[0]));let n=[0,0,0,r];for(let s=0;s<3;s++)e[s]+2*a>=t[s]&&(n[s]=Math.trunc((e[s]-t[s]+2*a)/i[s]+1));return n},Du=(e,t,r,i,a,n,s,u,l,d)=>{let c,f,h,g;if(e==="VALID"&&(e=0),typeof e=="number"){c={top:e,bottom:e,left:e,right:e,front:e,back:e};let _=ji([t,r,i,1],[u,l,d],1,[a,n,s],e);f=_[0],h=_[1],g=_[2]}else if(Array.isArray(e)){if(!e.every((b,k,v)=>b===v[0]))throw Error(`Unsupported padding parameter: ${e}`);c={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let _=ji([t,r,i,1],[u,l,d],1,[a,n,s],e[0]);f=_[0],h=_[1],g=_[2]}else if(e==="SAME_UPPER"){f=Math.ceil(t/a),h=Math.ceil(r/n),g=Math.ceil(i/s);let _=(f-1)*a+u-t,b=(h-1)*n+l-r,k=(g-1)*s+d-i,v=Math.floor(_/2),w=_-v,S=Math.floor(b/2),x=b-S,T=Math.floor(k/2),z=k-T;c={top:S,bottom:x,left:T,right:z,front:v,back:w}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:c,outDepth:f,outHeight:h,outWidth:g}},Pu=(e,t,r,i,a,n=!1,s="channelsLast")=>{let u,l,d,c,f;if(s==="channelsLast")[u,l,d,c,f]=e;else if(s==="channelsFirst")[u,f,l,d,c]=e;else throw new Error(`Unknown dataFormat ${s}`);let[h,,g,_,b]=t,[k,v,w]=Fi(r),[S,x,T]=Fi(i),z=Ft(g,S),E=Ft(_,x),O=Ft(b,T),{padInfo:M,outDepth:W,outHeight:X,outWidth:F}=Du(a,l,d,c,k,v,w,z,E,O),ee=n?h*f:h,U=[0,0,0,0,0];return s==="channelsFirst"?U=[u,ee,W,X,F]:s==="channelsLast"&&(U=[u,W,X,F,ee]),{batchSize:u,dataFormat:s,inDepth:l,inHeight:d,inWidth:c,inChannels:f,outDepth:W,outHeight:X,outWidth:F,outChannels:ee,padInfo:M,strideDepth:k,strideHeight:v,strideWidth:w,filterDepth:g,filterHeight:_,filterWidth:b,effectiveFilterDepth:z,effectiveFilterHeight:E,effectiveFilterWidth:O,dilationDepth:S,dilationHeight:x,dilationWidth:T,inShape:e,outShape:U,filterShape:t}},Uu=(e,t,r,i,a,n)=>{let s=n==="channelsLast";s?e[0].dims[3]:e[0].dims[1];let u=[64,1,1],l={x:r.map((k,v)=>v)},d=[Math.ceil(Mu(l.x.map(k=>r[k]))/u[0]),1,1];le("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${d}`);let c=1,f=C.size(r),h=[{type:12,data:f},{type:12,data:i},{type:12,data:a},{type:12,data:t.strides},{type:12,data:t.dilations}];bt(t,h),h.push(...Z(e[0].dims,e[1].dims));let g=["rank","rank"],_=e.length===3;_&&(h.push(...Z(e[2].dims)),g.push("rank")),h.push(...Z(r));let b=k=>{let v=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:i.length},{name:"pads",type:"u32",length:a.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];wt(t,v);let w=1,S=ke(e[0].dataType),x=R("x",e[0].dataType,e[0].dims.length,c),T=R("W",e[1].dataType,e[1].dims.length,w),z=[x,T],E=G("result",e[0].dataType,r.length,w),O="";if(_){let X=R("bias",e[2].dataType,e[2].dims.length,w);z.push(X),O+=`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${f}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:g}),getShaderSource:b}},Lu=(e,t,r,i)=>{let a=e.length>2,n=be(r[3]),s=be(r[2]),u=C.size(r)/n/s,l=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/n],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/n],c=[r[0],r[1],r[2],r[3]/n],f=[{type:12,data:u},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];bt(t,f),f.push(...Z(l,d,c));let h=(s-1)*t.strides[1]+d[1],g=_=>{let b=G("output",e[0].dataType,c.length,n),k=ke(b.type.tensor),v=yt(t,b.type.value,k),w=R("x",e[0].dataType,l.length,n),S=R("w",e[1].dataType,d.length,n),x=[w,S];a&&x.push(R("b",e[2].dataType,e[2].dims,n));let T=a?"value += b[output_channel];":"",z=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return wt(t,z),`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${n};${s};${h};${d[0]};${d[1]}`,inputDependencies:a?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:f}),getShaderSource:g}}}),Wu,$r,Vu,vr,Ki,Zi,Gu,Hu,Xi,mh=P(()=>{re(),ch(),fh(),Hi(),hh(),$t(),Li(),nt(),Wu=(e,t,r,i,a,n)=>{let s=e[0],u=e.slice(n?1:2,n?3:4),l=u.length,d=t[0],c=t.slice(2).map((h,g)=>h+(h-1)*(r[g]-1)),f=u.map((h,g)=>h+i[g]+i[g+l]).map((h,g)=>Math.floor((h-c[g]+a[g])/a[g]));return f.splice(0,0,s),f.splice(n?3:1,0,d),f},$r=[2,3,1,0],Vu=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],i=e[1].dims[1]*t.group;if(r!==i)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let a=e[0].dims.length-2;if(t.dilations.length!==a)throw new Error(`dilations should be ${a}D`);if(t.strides.length!==a)throw new Error(`strides should be ${a}D`);if(t.pads.length!==a*2)throw new Error(`pads should be ${a*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},vr=(e,t)=>{let r=e.kernelShape.slice();r.length<t[1].dims.length-2&&r.push(...Array(t[1].dims.length-2-r.length).fill(0));for(let n=2;n<t[1].dims.length;++n)r[n-2]===0&&(r[n-2]=t[1].dims[n]);let i=e.pads.slice();fr.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,i,e.format==="NHWC",e.autoPad);let a=Object.assign({},e);return Object.assign(a,{kernelShape:r,pads:i}),a},Ki=e=>{let t=Pi(e),r=e.format,i=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],a=e.dilations,n=e.group,s=e.kernel_shape,u=e.pads,l=e.strides,d=e.w_is_const();return{autoPad:i,format:r,dilations:a,group:n,kernelShape:s,pads:u,strides:l,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},Zi=(e,t,r,i)=>{let a=r.format==="NHWC",n=Wu(t[0].dims,t[1].dims,r.dilations,r.pads,r.strides,a);if(r.group!==1){let z=[t[0]];if(a){let E=e.kernelCustomData.wT??e.compute(Re(t[1],$r),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=E),z.push(E)}else z.push(t[1]);t.length===3&&z.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&a&&t[1].dims[0]===r.group&&t[1].dims[1]===1&&r.dilations[0]===1&&r.dilations[1]===1?e.compute(Lu(z,r,n,i),{inputs:z}):e.compute(qu(z,r,n,i),{inputs:z});return}let s=t.length===3,u=t[0].dims[a?1:2],l=t[0].dims[a?2:3],d=t[0].dims[a?3:1],c=t[1].dims[2],f=t[1].dims[3],h=n[a?1:2],g=n[a?2:3],_=n[a?3:1],b=a&&c===u&&f===l&&r.pads[0]===0&&r.pads[1]===0;if(b||c===1&&f===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let z=n[0],E,O,M,W=[];if(a){let ee=e.kernelCustomData.wT??e.compute(Re(t[1],$r),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=ee),b){let U=u*l*d;E=t[0].reshape([1,z,U]),O=ee.reshape([1,U,_]),M=[1,z,_]}else E=t[0].reshape([z,u*l,d]),O=ee.reshape([1,d,_]),M=[z,h*g,_];W.push(E),W.push(O)}else E=t[0].reshape([z,d,u*l]),O=t[1].reshape([1,_,d]),M=[z,_,h*g],W.push(O),W.push(E);s&&W.push(t[2]);let X=M[2],F=W[0].dims[W[0].dims.length-1];X<8&&F<8?e.compute(qi(W,r,n,M,a,i),{inputs:W}):e.compute(wr(W,r,n,M,a,i),{inputs:W});return}let k=!0,v=e.kernelCustomData.wT??e.compute(Re(t[1],$r),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=v);let w=[t[0],v];s&&w.push(t[2]);let S=a?h*g:_,x=a?_:h*g,T=c*f*d;e.compute(Bu(w,r,n,S,x,T,s,k,i),{inputs:w})},Gu=(e,t)=>{let r=t.format==="NHWC",i=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&i.push(e.inputs[2]);let a=[0,t.pads[0],0,t.pads[1]],n=[1].concat(t.strides),s=[1].concat(t.dilations),u=[1].concat(t.kernelShape),l=vr({...t,pads:a,strides:n,dilations:s,kernelShape:u},i);Zi(e,i,l,d=>r?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},Hu=(e,t,r)=>{let i=r.format==="NHWC"?"channelsLast":"channelsFirst",a=vr(r,t),n=r.autoPad==="NOTSET"?r.pads:r.autoPad,s=Pu(t[0].dims,t[1].dims,r.strides,r.dilations,n,!1,i);e.compute(Uu(t,a,s.outShape,[s.filterDepth,s.filterHeight,s.filterWidth],[s.padInfo.front,s.padInfo.top,s.padInfo.left],i))},Xi=(e,t)=>{if(Vu(e.inputs,t),e.inputs[0].dims.length===3)Gu(e,t);else if(e.inputs[0].dims.length===5)Hu(e,e.inputs,t);else{let r=vr(t,e.inputs);Zi(e,e.inputs,r)}}}),Fu,gh=P(()=>{J(),Je(),re(),ne(),Fu=(e,t,r)=>{let i=e.length>2,a=t.outputShape,n=t.format==="NHWC",s=t.group,u=e[1].dims,l=u[2]/s,d=u[3],c=n?be(l):1,f=n&&d===1&&l>=4,h=f?Math.floor(l/4)*4:Math.floor(l/c)*c,g=l-h,_=n?be(d):1,b=n?d===1?c:_:1,k=C.size(a)/_,v=[Math.ceil(k/64),1,1];le("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${v}`);let w=["rank","rank"],S=[t.strides[0],t.strides[1]],x=[t.kernelShape[n?1:2],t.kernelShape[n?2:3]],T=[t.dilations[0],t.dilations[1]],z=[x[0]+(t.dilations[0]<=1?0:(t.kernelShape[n?1:2]-1)*(t.dilations[0]-1)),x[1]+(t.dilations[1]<=1?0:(t.kernelShape[n?2:3]-1)*(t.dilations[1]-1))],E=[z[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),z[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],O=[{type:12,data:k},{type:12,data:S},{type:12,data:x},{type:12,data:T},{type:12,data:z},{type:6,data:E},{type:12,data:h},{type:12,data:l},{type:12,data:d},...Z(e[0].dims,e[1].dims)];i&&(O.push(...Z(e[2].dims)),w.push("rank")),O.push(...Z(a));let M=W=>{let X=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:S.length},{name:"filter_dims",type:"u32",length:x.length},{name:"dilations",type:"u32",length:x.length},{name:"effective_filter_dims",type:"u32",length:z.length},{name:"pads",type:"i32",length:E.length},{name:"input_channels_per_group_int",type:"u32"},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],F=ke(e[0].dataType),ee=n?1:2,U=n?2:3,ie=n?3:1,Q=R("W",e[1].dataType,e[1].dims.length,b),V=R("Dy",e[0].dataType,e[0].dims.length,c),oe=[V,Q];i&&oe.push(R("bias",e[2].dataType,[a[ie]].length,_));let j=G("result",e[0].dataType,a.length,_),ue=()=>{let te="";if(f)c===4?te+=`
...
`)};
    ...
    ${_}`},c=[{type:12,data:l},...Z(t,i)];return{name:"Expand",shaderCache:{hint:`${i.length};${s}${u}`,inputDependencies:["rank"]},getShaderSource:d,getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:c})}},yl=e=>{ml(e.inputs),e.compute(_l(e.inputs),{inputs:[0]})}}),bl,wl,vh=P(()=>{J(),re(),ne(),Di(),bl=e=>{let t=e[0].dataType,r=C.size(e[0].dims),i=C.size(e[1].dims),a=i%4===0,n=s=>{let u=R("x",t,[1],4),l=R("bias",t,[1],4),d=G("y",t,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],f=g=>`
  ...
  ${h.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((g,_)=>_!==1).map(g=>g.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(g,_)=>"rank")},getRunData:()=>({outputs:[{dims:u,dataType:d}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:f}),getShaderSource:h}},Cl=(e,t)=>{let r=e.inputs;El(r,t),e.compute(zl(e.inputs,t))},Ol=e=>ce({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),Al,Rl,Bl,Ml,Th=P(()=>{J(),re(),we(),ne(),Al=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
...
`)}
  ...
  }`};e.compute({name:"InstanceNormalization",shaderCache:{hint:`${d}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:a,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:[{type:12,data:c},...Z(h,g,h)]}),getShaderSource:b},{inputs:[t[0],f]})},gd=(e,t,r)=>{let i=t[0].dims,a=i,n=i[0],s=i[i.length-1],u=C.sizeFromDimension(i,1)/s,l=be(s),d=C.size(a)/l,c=[{type:12,data:u},{type:12,data:Math.floor(s/l)}],f=["type","type"],h=!1,g=[0,i.length-1];for(let v=0;v<i.length-2;v++)h=h||i[v+1]!==1,g.push(v+1);h=h&&i[i.length-1]!==1;let _=h?e.compute(Re(e.inputs[0],g),{inputs:[e.inputs[0]],outputs:[-1]})[0]:e.inputs[0].reshape(Array.from({length:i.length},(v,w)=>i[g[w]])),b=na(e,_,t[1],t[2],n,u,s,r.epsilon),k=v=>{let w=ke(t[0].dataType),S=l===1?"vec2f":`mat${l}x2f`,x=E=>{let O=E===0?"x":"y",M=l===1?"f32":`vec${l}f`;switch(l){case 1:return`${w}(${M}(scale.${O}))`;case 2:return`vec2<${w}>(${M}(scale[0].${O}, scale[1].${O}))`;case 4:return`vec4<${w}>(${M}(scale[0].${O}, scale[1].${O}, scale[2].${O}, scale[3].${O}))`;default:throw new Error(`Not supported compoents ${l}`)}},T=R("input",t[0].dataType,t[0].dims,l),z=G("output",t[0].dataType,a,l);return`
  ...
  ${T.mainStart()}
      ...
      `},Cd=(e,t,r)=>{let i="";for(let a=t-1;a>=0;--a)i+=`
          ...
          `},Ad=(e,t,r)=>{let i="";for(let a=t-1;a>=0;--a)i+=`
            ...
            `;return`
              ...
              ${i}
              value = x[offset];
          `},Rd=(e,t,r)=>{switch(r.mode){case 0:return zd(e,t,r.pads.length);case 1:return Cd(e,t,r.pads.length);case 2:return Od(e,t,r.pads.length);case 3:return Ad(e,t,r.pads.length);default:throw new Error("Invalid mode")}},Bd=(e,t)=>{let r=C.padShape(e[0].dims.slice(),t.pads),i=e[0].dims,a=C.size(r),n=[{type:12,data:a},{type:6,data:t.pads}],s=e.length>=3&&e[2].data;t.mode===0&&n.push({type:s?e[2].dataType:1,data:t.value}),n.push(...Z(e[0].dims,r));let u=["rank"],l=d=>{let c=G("output",e[0].dataType,r.length),f=R("x",e[0].dataType,i.length),h=f.type.value,g=Rd(c,i.length,t),_=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&_.push({name:"constant_value",type:s?h:"f32"}),`
    ...
    `,u="",l=R("x",t.dataType,t.dims.length),d=["rank"],[c,f,h,g,_]=oa(n,a);return c.push(...Z(t.dims,n)),{name:e,shaderCache:{hint:`${i.cacheKey};${h};${g};${_}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:n,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(C.size(n)/64)},programUniforms:c}),getShaderSource:b=>ua(b,l,t.dims.length,n.length,a,s,u,t.dataType===10?-65504:-1e5,f,h,g,_)}},Vd=(e,t)=>{Zt(e.inputs),e.compute(fa("MaxPool",e.inputs[0],!1,t))},Gd=e=>{let t=e.storage_order,r=e.dilations,i=da(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(i.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let a={storageOrder:t,dilations:r,...i,cacheKey:""};return{...a,cacheKey:Pd(a)}},Hd=e=>{let t=e.format;return{format:t,...ca,cacheKey:t}},Fd=(e,t)=>{Zt(e.inputs),e.compute(fa("GlobalMaxPool",e.inputs[0],!0,t))}}),jd,Kd,Zd,Xd,Nh=P(()=>{J(),re(),we(),ne(),jd=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,i)=>r===e[2].dims[i]).reduce((r,i)=>r&&i,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((a,n)=>n===t.axis||a===e[0].dims[n]).reduce((a,n)=>a&&n,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],i=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/i)||t.blockSize>Math.ceil(r/(i-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Kd=(e,t)=>{let r=C.normalizeAxis(t.axis,e[0].dims.length),i=e[0].dataType,a=i===3,n=e[0].dims,s=e[1].dataType,u=C.size(n),l=i===3||i===2,d=l?[Math.ceil(C.size(e[0].dims)/4)]:e[0].dims,c=e[1].dims,f=e.length>2?e[2]:void 0,h=f?l?[Math.ceil(C.size(f.dims)/4)]:f.dims:void 0,g=c.length===0||c.length===1&&c[0]===1,_=g===!1&&c.length===1,b=be(u),k=g&&(!l||b===4),v=k?b:1,w=k&&!l?b:1,S=R("input",l?12:i,d.length,w),x=R("scale",s,c.length),T=f?R("zero_point",l?12:i,h.length):void 0,z=G("output",s,n.length,v),E=[S,x];T&&E.push(T);let O=[d,c];f&&O.push(h);let M=[{type:12,data:u/v},{type:12,data:r},{type:12,data:t.blockSize},...Z(...O,n)],W=X=>{let F=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:T?["rank","rank","rank"]:["rank","rank"]},getShaderSource:W,getRunData:()=>({outputs:[{dims:n,dataType:s}],dispatchGroup:{x:Math.ceil(u/v/64),y:1,z:1},programUniforms:M})}},Zd=(e,t)=>{jd(e.inputs,t),e.compute(Kd(e.inputs,t))},Xd=e=>ce({axis:e.axis,blockSize:e.blockSize})}),Qd,Yd,Jd,Dh=P(()=>{qe(),J(),ne(),Qd=(e,t,r)=>{let i=e===t,a=e<t&&r<0,n=e>t&&r>0;if(i||a||n)throw new Error("Range these inputs' contents are invalid.")},Yd=(e,t,r,i)=>{let a=Math.abs(Math.ceil((t-e)/r)),n=[a],s=a,u=[{type:12,data:s},{type:i,data:e},{type:i,data:r},...Z(n)],l=d=>{let c=G("output",i,n.length),f=c.type.value,h=[{name:"outputSize",type:"u32"},{name:"start",type:f},{name:"delta",type:f}];return`
        ${d.registerUniforms(h).declareVariables(c)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${f}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${i}`},getShaderSource:l,getRunData:()=>({outputs:[{dims:n,dataType:i}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u})}},Jd=e=>{let t=0,r=0,i=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],i=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],i=e.inputs[2].getFloat32Array()[0]),ge.webgpu.validateInputContent&&Qd(t,r,i),e.compute(Yd(t,r,i,e.inputs[0].dataType),{inputs:[]})}}),ep,ha,ma,tp,rp,ip,Ph=P(()=>{J(),re(),we(),ne(),ep=(e,t,r,i)=>{if(e!=="none"&&i!=="i32"&&i!=="u32"&&i!=="f32")throw new Error(`Input ${i} is not supported with reduction ${e}.`);let a=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,n=`;
    ...
    data_offset += u32((u32(index) * element_count_dim));`,ma=(e,t,r)=>`for (var i = 0u; i < uniforms.num_updates_elements; i++) {
      ...
      }`,tp=(e,t)=>{let r=e[0].dims,i=e[1].dims,a=r,n=1,s=Math.ceil(C.size(i)/n),u=i[i.length-1],l=C.sizeFromDimension(r,u),d=C.sizeFromDimension(i,0)/u,c=[{type:12,data:s},{type:12,data:u},{type:12,data:l},...Z(e[1].dims,e[2].dims,a)],f=h=>{let g=R("indices",e[1].dataType,e[1].dims.length),_=R("updates",e[2].dataType,e[2].dims.length,n),b=t.reduction!=="none"&&t.reduction!==""?us("output",e[0].dataType,a.length):G("output",e[0].dataType,a.length,n);return`
...
`:"",mp=(e,t,r,i,a)=>{let[n,s,u,l]=r.length===2?[-1,0,1,-1]:[0,2,3,1],d=e.type.value;return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${g} {
    ...
    }`},yp=(e,t,r,i,a,n)=>{let s=e.dims,u=lp(n,t.axes,s.length),l=dp(s,i,a,t.axes),d=i.slice();i.length===0&&(d=s.map((w,S)=>w===0?1:l[S]/w),t.keepAspectRatioPolicy!=="stretch"&&(l=pp(s,d,t)));let c=G("output",e.dataType,l.length),f=R("input",e.dataType,s.length),h=C.size(l),g=s.length===l.length&&s.every((w,S)=>w===l[S]),_=t.coordinateTransformMode==="tf_crop_and_resize",b=t.extrapolationValue,k=f.type.value,v=w=>`
      ${g?"":`
...
`}
      ...
      }`},x=[{dims:u,dataType:e[0].dataType}];return r>1&&x.push({dims:c,dataType:1}),r>2&&x.push({dims:c,dataType:1}),r>3&&x.push({dims:n,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${v};${g};${_};${b}`,inputDependencies:e.map((T,z)=>"type")},getShaderSource:S,getRunData:()=>({outputs:x,dispatchGroup:{x:Math.ceil(l/d)},programUniforms:w})}},kp=(e,t)=>{vp(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(xp(e.inputs,t,e.outputCount,!1),{outputs:r})}}),Sp,Xt,Tp,ya,Ip,Ep,zp,Cp,Lh=P(()=>{J(),re(),we(),ne(),Sp=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,i)=>{if(e[i+1].dataType!==6&&e[i+1].dataType!==7)throw new Error(`Input ${i} must be an array of int32 or int64`)})},Xt=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(i=>r.push(Number(i)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(i=>r.push(Number(i)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Tp=(e,t)=>{if(e.length>1){let r=Xt(e,1),i=Xt(e,2),a=Xt(e,3);return a.length===0&&(a=[...Array(e[0].dims.length).keys()]),ce({starts:r,ends:i,axes:a})}else return t},ya=(e,t,r,i,a)=>{let n=e;return e<0&&(n+=r[i[t]]),a[t]<0?Math.max(0,Math.min(n,r[i[t]]-1)):Math.max(0,Math.min(n,r[i[t]]))},Ip=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${l.length}_${s.length}_${n.length}`,inputDependencies:["rank"]},getShaderSource:k,getRunData:()=>({outputs:[c],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:b})}},zp=(e,t)=>{Sp(e.inputs,t);let r=Tp(e.inputs,t);e.compute(Ep(e.inputs,r),{inputs:[0]})},Cp=e=>{let t=e.starts,r=e.ends,i=e.axes;return ce({starts:t,ends:r,axes:i})}}),Op,Ap,Rp,Bp,Wh=P(()=>{J(),re(),we(),nt(),ne(),Op=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Ap=(e,t)=>{let r=e.inputs[0],i=r.dims,a=C.size(i),n=i.length,s=C.normalizeAxis(t.axis,n),u=s<i.length-1,l,d=[];u?(d=Array.from({length:n},(E,O)=>O),d[s]=n-1,d[n-1]=s,l=e.compute(Re(r,d),{inputs:[r],outputs:[-1]})[0]):l=r;let c=l.dims,f=c[n-1],h=a/f,g=be(f),_=f/g,b=64;h===1&&(b=256);let k=(E,O)=>O===4?`max(max(${E}.x, ${E}.y), max(${E}.z, ${E}.w))`:O===2?`max(${E}.x, ${E}.y)`:O===3?`max(max(${E}.x, ${E}.y), ${E}.z)`:E,v=R("x",l.dataType,l.dims,g),w=G("result",l.dataType,l.dims,g),S=v.type.value,x=ke(l.dataType)==="f32"?`var threadMax = ${S}(-3.402823e+38f);`:`var threadMax = ${S}(-65504.0h);`,T=E=>`
 ...
 * limitations under the License.
 * =============================================================================
 */let Rt=null;const Yh=.1,Jh=.1,em=2.5,tm=2,hc=2e3,rm=80;self.addEventListener("message",async e=>{const{type:t,data:r}=e.data;switch(t){case"INIT":try{const i=["webgl","wasm"];console.log("Initializing detection model:",r.modelPath),Rt=await jr.create(r.modelPath,{executionProviders:i,graphOptimizationLevel:"all"}),console.log("Detection model initialized successfully"),console.log("Input names:",Rt.inputNames),console.log("Output names:",Rt.outputNames),self.postMessage({type:"RESULT",data:{initialized:!0}})}catch(i){self.postMessage({type:"ERROR",error:i.message})}break;case"PROCESS":if(!Rt){self.postMessage({type:"ERROR",error:"Model not initialized"});return}try{const{imageData:i,width:a,height:n,isDocument:s=!1}=r;s&&console.log("Using document-optimized detection parameters");const{resizedWidth:u,resizedHeight:l,ratioW:d,ratioH:c}=im(a,n),f=am(i,a,n,u,l),h=Rt.inputNames[0]||"x",g={};g[h]=f;const _=await Rt.run(g),b=nm(_,u,l,d,c,s);self.postMessage({type:"RESULT",data:{boxes:b}})}catch(i){self.postMessage({type:"ERROR",error:i.message})}break}});function im(e,t,r=1280){let i=e,a=t;const s=t>e&&Math.min(e,t)>1e3?1920:r;Math.max(e,t)>s&&(e>t?(i=s,a=Math.round(t*s/e)):(a=s,i=Math.round(e*s/t))),i=Math.ceil(i/32)*32,a=Math.ceil(a/32)*32;const u=e/i,l=t/a;return{resizedWidth:i,resizedHeight:a,ratioW:u,ratioH:l}}function am(e,t,r,i,a){const s=new OffscreenCanvas(i,a).getContext("2d"),u=new ImageData(new Uint8ClampedArray(e),t,r),l=new OffscreenCanvas(t,r);l.getContext("2d").putImageData(u,0,0),s.drawImage(l,0,0,t,r,0,0,i,a);const c=s.getImageData(0,0,i,a).data,f=[.485,.456,.406],h=[.229,.224,.225],g=new Float32Array(3*i*a);for(let _=0;_<a;_++)for(let b=0;b<i;b++){const k=(_*i+b)*4,v=_*i+b;g[v]=(c[k]/255-f[0])/h[0],g[a*i+v]=(c[k+1]/255-f[1])/h[1],g[2*a*i+v]=(c[k+2]/255-f[2])/h[2]}return new Pe("float32",g,[1,3,a,i])}function nm(e,t,r,i,a,n=!1){const s=Object.keys(e)[0];console.log("Detection output name:",s);const u=e[s];if(!u)return console.error("No output found in results. Available outputs:",Object.keys(e)),[];console.log("Output shape:",u.dims),console.log("Output data length:",u.data.length);const l=u.data,[,,d,c]=u.dims,f=n?.02:Yh,h=n?.05:Jh,g=n?4:em,_=n?1:tm;console.log("Detection parameters:",{isDocument:n,threshold:f,boxThreshold:h,unclipRatio:g});const b=new Uint8Array(d*c);let k=0,v=0,w=1;for(let z=0;z<l.length;z++){const E=l[z];v=Math.max(v,E),w=Math.min(w,E),E>f?(b[z]=255,k++):b[z]=0}console.log("Detection probability stats:",{min:w,max:v,threshold:f,pixelsAboveThreshold:k,totalPixels:l.length,percentageAbove:(k/l.length*100).toFixed(2)+"%"});const S=sm(b,c,d,n);console.log(`Found ${S.length} contours`);const x=[],T={no_rect:0,low_score:0,no_expanded_box:0,too_small:0};for(const z of S){const E=pm(z);if(!E){T.no_rect++;continue}const O=cm(l,E,c,d);if(O<h){T.low_score++,console.log(`Box rejected: score ${O.toFixed(3)} < threshold ${h}`);continue}const M=fm(E,g);if(!M){T.no_expanded_box++;continue}const W=Math.abs(M.topRight.x-M.topLeft.x),X=Math.abs(M.bottomLeft.y-M.topLeft.y);if(Math.min(W,X)<_){T.too_small++,console.log(`Box rejected: size ${Math.min(W,X).toFixed(1)} < minimum ${_}`);continue}x.push({topLeft:{x:M.topLeft.x*i,y:M.topLeft.y*a},topRight:{x:M.topRight.x*i,y:M.topRight.y*a},bottomRight:{x:M.bottomRight.x*i,y:M.bottomRight.y*a},bottomLeft:{x:M.bottomLeft.x*i,y:M.bottomLeft.y*a}})}if(console.log("Box filtering results:",{totalContours:S.length,acceptedBoxes:x.length,rejectionReasons:T}),n&&x.length>0){const z=hm(x);return console.log(`Merged ${x.length} boxes into ${z.length} paragraph boxes`),z}return x}function sm(e,t,r,i=!1){const a=new Uint8Array(t*r),n=[],u=om(e,t,r,i?7:2);let l=u;i&&(l=um(u,t,r,7),l=lm(l,t,r,3));for(let d=0;d<r;d++)for(let c=0;c<t;c++){const f=d*t+c;if(l[f]===255&&!a[f]){const h=dm(l,a,c,d,t,r);h.length>5&&n.push(h)}}return n.length>hc?(n.sort((d,c)=>c.length-d.length),n.slice(0,hc)):n}function om(e,t,r,i){const a=new Uint8Array(e),n=Math.floor(i/2);for(let s=n;s<r-n;s++)for(let u=n;u<t-n;u++){let l=0;for(let d=-n;d<=n;d++)for(let c=-n;c<=n;c++){const f=(s+d)*t+(u+c);l=Math.max(l,e[f])}a[s*t+u]=l}return a}function um(e,t,r,i){const a=new Uint8Array(e),n=Math.floor(i/2);for(let s=0;s<r;s++)for(let u=n;u<t-n;u++){let l=0;for(let d=-n;d<=n;d++){const c=s*t+(u+d);l=Math.max(l,e[c])}a[s*t+u]=l}return a}function lm(e,t,r,i){const a=new Uint8Array(e),n=Math.floor(i/2);for(let s=n;s<r-n;s++)for(let u=0;u<t;u++){let l=0;for(let d=-n;d<=n;d++){const c=(s+d)*t+u;l=Math.max(l,e[c])}a[s*t+u]=l}return a}function dm(e,t,r,i,a,n){const s=[],u=[{x:r,y:i}],l=[-1,0,1,-1,1,-1,0,1],d=[-1,-1,-1,0,0,1,1,1];for(;u.length>0;){const{x:c,y:f}=u.pop(),h=f*a+c;if(!(c<0||c>=a||f<0||f>=n||t[h]||e[h]!==255)){t[h]=1,s.push({x:c,y:f});for(let g=0;g<8;g++)u.push({x:c+l[g],y:f+d[g]})}}return s}function pm(e){if(e.length<4)return null;let t=1/0,r=1/0,i=-1/0,a=-1/0;for(const u of e)t=Math.min(t,u.x),r=Math.min(r,u.y),i=Math.max(i,u.x),a=Math.max(a,u.y);const n=i-t;if(a-r<5&&n>20){const u=(r+a)/2;r=u-5,a=u+5}return{topLeft:{x:t,y:r},topRight:{x:i,y:r},bottomRight:{x:i,y:a},bottomLeft:{x:t,y:a}}}function cm(e,t,r,i){const a=Math.floor(Math.min(t.topLeft.x,t.bottomLeft.x)),n=Math.ceil(Math.max(t.topRight.x,t.bottomRight.x)),s=Math.floor(Math.min(t.topLeft.y,t.topRight.y)),u=Math.ceil(Math.max(t.bottomLeft.y,t.bottomRight.y));let l=0,d=0;for(let c=Math.max(0,s);c<Math.min(i,u);c++)for(let f=Math.max(0,a);f<Math.min(r,n);f++)l+=e[c*r+f],d++;return d>0?l/d:0}function fm(e,t){const r=(e.topLeft.x+e.topRight.x+e.bottomLeft.x+e.bottomRight.x)/4,i=(e.topLeft.y+e.topRight.y+e.bottomLeft.y+e.bottomRight.y)/4,a=Math.max(Math.abs(e.topRight.x-e.topLeft.x),Math.abs(e.bottomRight.x-e.bottomLeft.x)),n=Math.max(Math.abs(e.bottomLeft.y-e.topLeft.y),Math.abs(e.bottomRight.y-e.topRight.y)),s=a*t,u=n*t;return{topLeft:{x:r-s/2,y:i-u/2},topRight:{x:r+s/2,y:i-u/2},bottomRight:{x:r+s/2,y:i+u/2},bottomLeft:{x:r-s/2,y:i+u/2}}}function hm(e){if(e.length===0)return e;const t=[...e].sort((a,n)=>{const s=(a.topLeft.y+a.bottomLeft.y)/2,u=(n.topLeft.y+n.bottomLeft.y)/2;return s-u}),r=[];let i=[t[0]];for(let a=1;a<t.length;a++){const n=t[a],s=i[i.length-1],u=n.topLeft.y-s.bottomLeft.y,l=Math.min(n.topLeft.x,n.bottomLeft.x),d=Math.max(n.topRight.x,n.bottomRight.x),c=Math.min(...i.map(g=>Math.min(g.topLeft.x,g.bottomLeft.x))),f=Math.max(...i.map(g=>Math.max(g.topRight.x,g.bottomRight.x))),h=!(d<c||l>f);u<rm&&h?i.push(n):(i.length>1?r.push(mc(i)):r.push(i[0]),i=[n])}return i.length>1?r.push(mc(i)):r.push(i[0]),r}function mc(e){const t=Math.min(...e.map(n=>Math.min(n.topLeft.x,n.bottomLeft.x))),r=Math.max(...e.map(n=>Math.max(n.topRight.x,n.bottomRight.x))),i=Math.min(...e.map(n=>Math.min(n.topLeft.y,n.topRight.y))),a=Math.max(...e.map(n=>Math.max(n.bottomLeft.y,n.bottomRight.y)));return{topLeft:{x:t,y:i},topRight:{x:r,y:i},bottomRight:{x:r,y:a},bottomLeft:{x:t,y:a}}}})();
