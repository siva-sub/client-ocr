...
var best_index : i32 = 0;`,`if (${i.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},wo=e=>{yo(e.inputs),e.compute(bo(e.inputs))}}),$o,de,vo,xo,ko,So,To,Io,Eo,zo,Co,Oo,Ao,Bo,Ro,Mo,Gt,No,br,Do,Po,Uo,qo,Lo,Wo,Vo,Go,Ho,Fo,jo,Ko,Zo,Xo,Qo,Yo,Ri,Jo,Mi,Ni,eu,tu,ru,iu,au,nu,Di=P(()=>{J(),re(),we(),ne(),$o=(e,t,r,i,a,n,s)=>{let u=Math.ceil(t/4),l="";typeof a=="string"?l=`${a}(a)`:l=a("a");let d=B("inputData",r,[u],4),c=G("outputData",i,[u],4),f=[{name:"vec_size",type:"u32"}];return s&&f.push(...s),`
...
}`,Do=e=>{let t=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,br(t)))},Po=e=>{e.compute(de(e.inputs[0],"Exp","exp"))},Uo=e=>{e.compute(de(e.inputs[0],"Floor","floor"))},qo=e=>{let t=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,br(t)))},Lo=(e,t)=>{let r=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"LeakyRelu",i=>`select(leaky_relu_alpha_ * ${i}, ${i}, ${i} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},Wo=e=>{e.compute(de(e.inputs[0],"Not",t=>`!${t}`))},Vo=e=>{e.compute(de(e.inputs[0],"Neg",t=>`-${t}`))},Go=e=>{e.compute(de(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Ho=e=>{let t=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},Fo=e=>{e.compute(de(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},jo=e=>ce(e),Ko=(e,t)=>{let r=Ie(e.inputs[0].dataType);e.compute(de(e.inputs[0],"HardSigmoid",i=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${i} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},Zo=e=>{e.compute(de(e.inputs[0],"Sin","sin"))},Xo=e=>{e.compute(de(e.inputs[0],"Sinh","sinh"))},Qo=e=>{e.compute(de(e.inputs[0],"Sqrt","sqrt"))},Yo=e=>{e.compute(de(e.inputs[0],"Tan","tan"))},Ri=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Jo=e=>{e.compute(de(e.inputs[0],"Tanh",Ri))},Mi=(e="f32")=>`
...
`},qi=(e,t,r,i,a=!1,n)=>{let s=e[0].dims,u=e[1].dims,l=s[s.length-2],d=u[u.length-1],c=s[s.length-1],f=be(d),h=be(c),g=be(l),_=C.size(r)/f/g,b=e.length>2,k=i?i.slice(0,-2):r.slice(0,-2),v=[C.size(k),l,d],w=[{type:12,data:_},{type:12,data:l},{type:12,data:d},{type:12,data:c}];bt(t,w),w.push(...Z(k,s,u)),b&&w.push(...Z(e[2].dims)),w.push(...Z(v));let S=x=>{let T=Ii("batch_dims",e[0].dataType,k.length),z=B("a",e[0].dataType,s.length,h),E=B("b",e[1].dataType,u.length,f),O=G("output",e[0].dataType,v.length,f),M=ke(O.type.tensor),W=yt(t,O.type.value,M),X=[z,E],F="";if(b){let ie=a?f:1;X.push(B("bias",e[2].dataType,e[2].dims.length,ie)),F=`${a?`value += bias[col / ${ie}];`:`value += ${O.type.value}(bias[row + i]);`}`}let ee=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];wt(t,ee);let U=()=>{let ie=`var a_data: ${z.type.value};`;for(let Q=0;Q<h;Q++)ie+=`
...
`)}
  ...
  }`};e.compute({name:"InstanceNormalization",shaderCache:{hint:`${d}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:a,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:[{type:12,data:c},...Z(h,g,h)]}),getShaderSource:b},{inputs:[t[0],f]})},gd=(e,t,r)=>{let i=t[0].dims,a=i,n=i[0],s=i[i.length-1],u=C.sizeFromDimension(i,1)/s,l=be(s),d=C.size(a)/l,c=[{type:12,data:u},{type:12,data:Math.floor(s/l)}],f=["type","type"],h=!1,g=[0,i.length-1];for(let v=0;v<i.length-2;v++)h=h||i[v+1]!==1,g.push(v+1);h=h&&i[i.length-1]!==1;let _=h?e.compute(Be(e.inputs[0],g),{inputs:[e.inputs[0]],outputs:[-1]})[0]:e.inputs[0].reshape(Array.from({length:i.length},(v,w)=>i[g[w]])),b=na(e,_,t[1],t[2],n,u,s,r.epsilon),k=v=>{let w=ke(t[0].dataType),S=l===1?"vec2f":`mat${l}x2f`,x=E=>{let O=E===0?"x":"y",M=l===1?"f32":`vec${l}f`;switch(l){case 1:return`${w}(${M}(scale.${O}))`;case 2:return`vec2<${w}>(${M}(scale[0].${O}, scale[1].${O}))`;case 4:return`vec4<${w}>(${M}(scale[0].${O}, scale[1].${O}, scale[2].${O}, scale[3].${O}))`;default:throw new Error(`Not supported compoents ${l}`)}},T=B("input",t[0].dataType,t[0].dims,l),z=G("output",t[0].dataType,a,l);return`
  ...
  ${T.mainStart()}
    ...
    `,u="",l=B("x",t.dataType,t.dims.length),d=["rank"],[c,f,h,g,_]=oa(n,a);return c.push(...Z(t.dims,n)),{name:e,shaderCache:{hint:`${i.cacheKey};${h};${g};${_}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:n,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(C.size(n)/64)},programUniforms:c}),getShaderSource:b=>ua(b,l,t.dims.length,n.length,a,s,u,t.dataType===10?-65504:-1e5,f,h,g,_)}},Vd=(e,t)=>{Zt(e.inputs),e.compute(fa("MaxPool",e.inputs[0],!1,t))},Gd=e=>{let t=e.storage_order,r=e.dilations,i=da(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(i.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let a={storageOrder:t,dilations:r,...i,cacheKey:""};return{...a,cacheKey:Pd(a)}},Hd=e=>{let t=e.format;return{format:t,...ca,cacheKey:t}},Fd=(e,t)=>{Zt(e.inputs),e.compute(fa("GlobalMaxPool",e.inputs[0],!0,t))}}),jd,Kd,Zd,Xd,Dh=P(()=>{J(),re(),we(),ne(),jd=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,i)=>r===e[2].dims[i]).reduce((r,i)=>r&&i,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((a,n)=>n===t.axis||a===e[0].dims[n]).reduce((a,n)=>a&&n,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],i=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/i)||t.blockSize>Math.ceil(r/(i-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Kd=(e,t)=>{let r=C.normalizeAxis(t.axis,e[0].dims.length),i=e[0].dataType,a=i===3,n=e[0].dims,s=e[1].dataType,u=C.size(n),l=i===3||i===2,d=l?[Math.ceil(C.size(e[0].dims)/4)]:e[0].dims,c=e[1].dims,f=e.length>2?e[2]:void 0,h=f?l?[Math.ceil(C.size(f.dims)/4)]:f.dims:void 0,g=c.length===0||c.length===1&&c[0]===1,_=g===!1&&c.length===1,b=be(u),k=g&&(!l||b===4),v=k?b:1,w=k&&!l?b:1,S=B("input",l?12:i,d.length,w),x=B("scale",s,c.length),T=f?B("zero_point",l?12:i,h.length):void 0,z=G("output",s,n.length,v),E=[S,x];T&&E.push(T);let O=[d,c];f&&O.push(h);let M=[{type:12,data:u/v},{type:12,data:r},{type:12,data:t.blockSize},...Z(...O,n)],W=X=>{let F=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:T?["rank","rank","rank"]:["rank","rank"]},getShaderSource:W,getRunData:()=>({outputs:[{dims:n,dataType:s}],dispatchGroup:{x:Math.ceil(u/v/64),y:1,z:1},programUniforms:M})}},Zd=(e,t)=>{jd(e.inputs,t),e.compute(Kd(e.inputs,t))},Xd=e=>ce({axis:e.axis,blockSize:e.blockSize})}),Qd,Yd,Jd,Ph=P(()=>{qe(),J(),ne(),Qd=(e,t,r)=>{let i=e===t,a=e<t&&r<0,n=e>t&&r>0;if(i||a||n)throw new Error("Range these inputs' contents are invalid.")},Yd=(e,t,r,i)=>{let a=Math.abs(Math.ceil((t-e)/r)),n=[a],s=a,u=[{type:12,data:s},{type:i,data:e},{type:i,data:r},...Z(n)],l=d=>{let c=G("output",i,n.length),f=c.type.value,h=[{name:"outputSize",type:"u32"},{name:"start",type:f},{name:"delta",type:f}];return`
        ${d.registerUniforms(h).declareVariables(c)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${f}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${i}`},getShaderSource:l,getRunData:()=>({outputs:[{dims:n,dataType:i}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u})}},Jd=e=>{let t=0,r=0,i=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],i=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],i=e.inputs[2].getFloat32Array()[0]),ge.webgpu.validateInputContent&&Qd(t,r,i),e.compute(Yd(t,r,i,e.inputs[0].dataType),{inputs:[]})}}),ep,ha,ma,tp,rp,ip,Uh=P(()=>{J(),re(),we(),ne(),ep=(e,t,r,i)=>{if(e!=="none"&&i!=="i32"&&i!=="u32"&&i!=="f32")throw new Error(`Input ${i} is not supported with reduction ${e}.`);let a=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,n=`;
...
`:"",mp=(e,t,r,i,a)=>{let[n,s,u,l]=r.length===2?[-1,0,1,-1]:[0,2,3,1],d=e.type.value;return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${g} {
    ...
    }`},yp=(e,t,r,i,a,n)=>{let s=e.dims,u=lp(n,t.axes,s.length),l=dp(s,i,a,t.axes),d=i.slice();i.length===0&&(d=s.map((w,S)=>w===0?1:l[S]/w),t.keepAspectRatioPolicy!=="stretch"&&(l=pp(s,d,t)));let c=G("output",e.dataType,l.length),f=B("input",e.dataType,s.length),h=C.size(l),g=s.length===l.length&&s.every((w,S)=>w===l[S]),_=t.coordinateTransformMode==="tf_crop_and_resize",b=t.extrapolationValue,k=f.type.value,v=w=>`
      ${g?"":`
...
`}
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${l.length}_${s.length}_${n.length}`,inputDependencies:["rank"]},getShaderSource:k,getRunData:()=>({outputs:[c],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:b})}},zp=(e,t)=>{Sp(e.inputs,t);let r=Tp(e.inputs,t);e.compute(Ep(e.inputs,r),{inputs:[0]})},Cp=e=>{let t=e.starts,r=e.ends,i=e.axes;return ce({starts:t,ends:r,axes:i})}}),Op,Ap,Bp,Rp,Vh=P(()=>{J(),re(),we(),nt(),ne(),Op=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Ap=(e,t)=>{let r=e.inputs[0],i=r.dims,a=C.size(i),n=i.length,s=C.normalizeAxis(t.axis,n),u=s<i.length-1,l,d=[];u?(d=Array.from({length:n},(E,O)=>O),d[s]=n-1,d[n-1]=s,l=e.compute(Be(r,d),{inputs:[r],outputs:[-1]})[0]):l=r;let c=l.dims,f=c[n-1],h=a/f,g=be(f),_=f/g,b=64;h===1&&(b=256);let k=(E,O)=>O===4?`max(max(${E}.x, ${E}.y), max(${E}.z, ${E}.w))`:O===2?`max(${E}.x, ${E}.y)`:O===3?`max(max(${E}.x, ${E}.y), ${E}.z)`:E,v=B("x",l.dataType,l.dims,g),w=G("result",l.dataType,l.dims,g),S=v.type.value,x=ke(l.dataType)==="f32"?`var threadMax = ${S}(-3.402823e+38f);`:`var threadMax = ${S}(-65504.0h);`,T=E=>`
 ...
 * limitations under the License.
 * =============================================================================
 */let Bt=null;const Jh=.1,em=.1,tm=2.5,rm=2,hc=2e3,mc=10;self.addEventListener("message",async e=>{const{type:t,data:r}=e.data;switch(t){case"INIT":try{const i=["webgl","wasm"];console.log("Initializing detection model:",r.modelPath),Bt=await jr.create(r.modelPath,{executionProviders:i,graphOptimizationLevel:"all"}),console.log("Detection model initialized successfully"),console.log("Input names:",Bt.inputNames),console.log("Output names:",Bt.outputNames),self.postMessage({type:"RESULT",data:{initialized:!0}})}catch(i){self.postMessage({type:"ERROR",error:i.message})}break;case"PROCESS":if(!Bt){self.postMessage({type:"ERROR",error:"Model not initialized"});return}try{const{imageData:i,width:a,height:n,isDocument:s=!1}=r;s&&console.log("Using document-optimized detection parameters");const{resizedWidth:u,resizedHeight:l,ratioW:d,ratioH:c}=im(a,n),f=am(i,a,n,u,l),h=Bt.inputNames[0]||"x",g={};g[h]=f;const _=await Bt.run(g),b=nm(_,u,l,d,c,s);self.postMessage({type:"RESULT",data:{boxes:b}})}catch(i){self.postMessage({type:"ERROR",error:i.message})}break}});function im(e,t,r=1280){let i=e,a=t;const s=t>e&&Math.min(e,t)>1e3?1920:r;Math.max(e,t)>s&&(e>t?(i=s,a=Math.round(t*s/e)):(a=s,i=Math.round(e*s/t))),i=Math.ceil(i/32)*32,a=Math.ceil(a/32)*32;const u=e/i,l=t/a;return{resizedWidth:i,resizedHeight:a,ratioW:u,ratioH:l}}function am(e,t,r,i,a){const s=new OffscreenCanvas(i,a).getContext("2d"),u=new ImageData(new Uint8ClampedArray(e),t,r),l=new OffscreenCanvas(t,r);l.getContext("2d").putImageData(u,0,0),s.drawImage(l,0,0,t,r,0,0,i,a);const c=s.getImageData(0,0,i,a).data,f=[.485,.456,.406],h=[.229,.224,.225],g=new Float32Array(3*i*a);for(let _=0;_<a;_++)for(let b=0;b<i;b++){const k=(_*i+b)*4,v=_*i+b;g[v]=(c[k]/255-f[0])/h[0],g[a*i+v]=(c[k+1]/255-f[1])/h[1],g[2*a*i+v]=(c[k+2]/255-f[2])/h[2]}return new Pe("float32",g,[1,3,a,i])}function nm(e,t,r,i,a,n=!1){const s=Object.keys(e)[0];console.log("Detection output name:",s);const u=e[s];if(!u)return console.error("No output found in results. Available outputs:",Object.keys(e)),[];console.log("Output shape:",u.dims),console.log("Output data length:",u.data.length);const l=u.data,[,,d,c]=u.dims,f=n?.02:Jh,h=n?.05:em,g=n?4:tm,_=n?1:rm;console.log("Detection parameters (v1.1.8):",{isDocument:n,threshold:f,boxThreshold:h,unclipRatio:g,mergeThreshold:mc});const b=new Uint8Array(d*c);let k=0,v=0,w=1;for(let z=0;z<l.length;z++){const E=l[z];v=Math.max(v,E),w=Math.min(w,E),E>f?(b[z]=255,k++):b[z]=0}console.log("Detection probability stats:",{min:w,max:v,threshold:f,pixelsAboveThreshold:k,totalPixels:l.length,percentageAbove:(k/l.length*100).toFixed(2)+"%"});const S=sm(b,c,d,n);console.log(`Found ${S.length} contours`);const x=[],T={no_rect:0,low_score:0,no_expanded_box:0,too_small:0};for(const z of S){const E=dm(z);if(!E){T.no_rect++;continue}const O=pm(l,E,c,d);if(O<h){T.low_score++,console.log(`Box rejected: score ${O.toFixed(3)} < threshold ${h}`);continue}const M=cm(E,g);if(!M){T.no_expanded_box++;continue}const W=Math.abs(M.topRight.x-M.topLeft.x),X=Math.abs(M.bottomLeft.y-M.topLeft.y);if(Math.min(W,X)<_){T.too_small++,console.log(`Box rejected: size ${Math.min(W,X).toFixed(1)} < minimum ${_}`);continue}x.push({topLeft:{x:M.topLeft.x*i,y:M.topLeft.y*a},topRight:{x:M.topRight.x*i,y:M.topRight.y*a},bottomRight:{x:M.bottomRight.x*i,y:M.bottomRight.y*a},bottomLeft:{x:M.bottomLeft.x*i,y:M.bottomLeft.y*a}})}if(console.log("Box filtering results:",{totalContours:S.length,acceptedBoxes:x.length,rejectionReasons:T}),n&&x.length>0){const z=fm(x);return console.log(`Merged ${x.length} boxes into ${z.length} paragraph boxes`),z}return x}function sm(e,t,r,i=!1){const a=new Uint8Array(t*r),n=[],u=om(e,t,r,i?3:2);let l=u;i&&(l=um(u,t,r,5));for(let d=0;d<r;d++)for(let c=0;c<t;c++){const f=d*t+c;if(l[f]===255&&!a[f]){const h=lm(l,a,c,d,t,r);h.length>5&&n.push(h)}}return n.length>hc?(n.sort((d,c)=>c.length-d.length),n.slice(0,hc)):n}function om(e,t,r,i){const a=new Uint8Array(e),n=Math.floor(i/2);for(let s=n;s<r-n;s++)for(let u=n;u<t-n;u++){let l=0;for(let d=-n;d<=n;d++)for(let c=-n;c<=n;c++){const f=(s+d)*t+(u+c);l=Math.max(l,e[f])}a[s*t+u]=l}return a}function um(e,t,r,i){const a=new Uint8Array(e),n=Math.floor(i/2);for(let s=0;s<r;s++)for(let u=n;u<t-n;u++){let l=0;for(let d=-n;d<=n;d++){const c=s*t+(u+d);l=Math.max(l,e[c])}a[s*t+u]=l}return a}function lm(e,t,r,i,a,n){const s=[],u=[{x:r,y:i}],l=[-1,0,1,-1,1,-1,0,1],d=[-1,-1,-1,0,0,1,1,1];for(;u.length>0;){const{x:c,y:f}=u.pop(),h=f*a+c;if(!(c<0||c>=a||f<0||f>=n||t[h]||e[h]!==255)){t[h]=1,s.push({x:c,y:f});for(let g=0;g<8;g++)u.push({x:c+l[g],y:f+d[g]})}}return s}function dm(e){if(e.length<4)return null;let t=1/0,r=1/0,i=-1/0,a=-1/0;for(const u of e)t=Math.min(t,u.x),r=Math.min(r,u.y),i=Math.max(i,u.x),a=Math.max(a,u.y);const n=i-t;if(a-r<5&&n>20){const u=(r+a)/2;r=u-5,a=u+5}return{topLeft:{x:t,y:r},topRight:{x:i,y:r},bottomRight:{x:i,y:a},bottomLeft:{x:t,y:a}}}function pm(e,t,r,i){const a=Math.floor(Math.min(t.topLeft.x,t.bottomLeft.x)),n=Math.ceil(Math.max(t.topRight.x,t.bottomRight.x)),s=Math.floor(Math.min(t.topLeft.y,t.topRight.y)),u=Math.ceil(Math.max(t.bottomLeft.y,t.bottomRight.y));let l=0,d=0;for(let c=Math.max(0,s);c<Math.min(i,u);c++)for(let f=Math.max(0,a);f<Math.min(r,n);f++)l+=e[c*r+f],d++;return d>0?l/d:0}function cm(e,t){const r=(e.topLeft.x+e.topRight.x+e.bottomLeft.x+e.bottomRight.x)/4,i=(e.topLeft.y+e.topRight.y+e.bottomLeft.y+e.bottomRight.y)/4,a=Math.max(Math.abs(e.topRight.x-e.topLeft.x),Math.abs(e.bottomRight.x-e.bottomLeft.x)),n=Math.max(Math.abs(e.bottomLeft.y-e.topLeft.y),Math.abs(e.bottomRight.y-e.topRight.y)),s=a*t,u=n*t;return{topLeft:{x:r-s/2,y:i-u/2},topRight:{x:r+s/2,y:i-u/2},bottomRight:{x:r+s/2,y:i+u/2},bottomLeft:{x:r-s/2,y:i+u/2}}}function fm(e){if(e.length===0)return e;const t=[...e].sort((a,n)=>{const s=(a.topLeft.y+a.bottomLeft.y)/2,u=(n.topLeft.y+n.bottomLeft.y)/2;return s-u}),r=[];let i=[t[0]];for(let a=1;a<t.length;a++){const n=t[a],s=Math.max(...i.map(f=>Math.max(f.bottomLeft.y,f.bottomRight.y))),u=Math.max(0,n.topLeft.y-s),l=Math.min(n.topLeft.x,n.bottomLeft.x),d=Math.max(n.topRight.x,n.bottomRight.x);let c=!1;for(const f of i){const h=Math.min(f.topLeft.x,f.bottomLeft.x),g=Math.max(f.topRight.x,f.bottomRight.x);if(!(d<h||l>g)){c=!0;break}}u<mc&&c?i.push(n):(i.length>1?r.push(gc(i)):r.push(i[0]),i=[n])}return i.length>1?r.push(gc(i)):r.push(i[0]),r}function gc(e){const t=Math.min(...e.map(n=>Math.min(n.topLeft.x,n.bottomLeft.x))),r=Math.max(...e.map(n=>Math.max(n.topRight.x,n.bottomRight.x))),i=Math.min(...e.map(n=>Math.min(n.topLeft.y,n.topRight.y))),a=Math.max(...e.map(n=>Math.max(n.bottomLeft.y,n.bottomRight.y)));return{topLeft:{x:t,y:i},topRight:{x:r,y:i},bottomRight:{x:r,y:a},bottomLeft:{x:t,y:a}}}})();
